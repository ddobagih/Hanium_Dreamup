...
```text
runs/reports/walksafe_tactile3_reviewed_yolo26s_20260523/
...
CUDA_VISIBLE_DEVICES="" python3 scripts/summarize_walksafe_tactile3_reviewed_yolo26s_run_20260523.py \
  --include-log-tail 40 \
  --out-json runs/reports/walksafe_tactile3_reviewed_yolo26s_20260523/reviewed_yolo26s_stage1_stage2_summary.json \
  --out-md runs/reports/walksafe_tactile3_reviewed_yolo26s_20260523/reviewed_yolo26s_stage1_stage2_summary.md
```
