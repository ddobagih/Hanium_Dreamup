...
```bash
cd /home/ddobagi/Code/hanium-dreamup
mkdir -p runs/reports/walksafe_tactile3_yolo26s_20260522
python3 scripts/summarize_walksafe_tactile3_yolo26s_run_20260522.py \
  ...
  --include-log-tail 20 \
  --out-json runs/reports/walksafe_tactile3_yolo26s_20260522/stage1_summary.json \
  --out-md runs/reports/walksafe_tactile3_yolo26s_20260522/stage1_summary.md
```
...
python3 scripts/summarize_walksafe_tactile3_yolo26s_run_20260522.py \
  ...
  --include-log-tail 20 \
  --out-json runs/reports/walksafe_tactile3_yolo26s_20260522/stage2_summary.json \
  --out-md runs/reports/walksafe_tactile3_yolo26s_20260522/stage2_summary.md
```
