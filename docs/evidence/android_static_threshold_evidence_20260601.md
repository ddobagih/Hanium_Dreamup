...
|---|---|---|---|
| Stage1 reviewed test presence sweep | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_20260523_203422/SUMMARY.md` | damaged_tactile_block image-level threshold tradeoff | fresh rerun 아님. 현재 selected reviewed dataset 부재 상태에서는 재현 불가 |
| Stage1 FP/FN candidates | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/SUMMARY.md` | threshold별 FP/FN 후보 목록 위치 | 원본 이미지/GT label을 다시 읽은 full eval 아님 |
| predictions manifest presence sweep | `reports/runs/evaluations/predictions_manifest_presence_20260531/SUMMARY.md` | predictions.json + manifest 기반 image-level presence 참고 | bbox IoU/mAP 아님. target_category_id 1 presence 기준 |
...
출처: `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_20260523_203422/SUMMARY.md`
...
출처: `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/SUMMARY.md`

| threshold | total | FP | FN | candidate csv | 용도 |
|---:|---:|---:|---:|---|---|
| 0.50 | 2347 | 62 | 119 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_050_fp_fn_candidates.csv` | 낮은 threshold 후보 검토 |
| 0.60 | 2347 | 50 | 137 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_060_fp_fn_candidates.csv` | tradeoff 검토 |
| 0.70 | 2347 | 42 | 160 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_070_fp_fn_candidates.csv` | tradeoff 검토 |
| 0.75 | 2347 | 40 | 177 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_075_fp_fn_candidates.csv` | tradeoff 검토 |
| 0.80 | 2347 | 37 | 208 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_080_fp_fn_candidates.csv` | 높은 precision 후보 검토 |
| 0.85 | 2347 | 34 | 231 | `reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/presence_threshold_085_fp_fn_candidates.csv` | 높은 precision 후보 검토 |
...
출처: `reports/runs/evaluations/predictions_manifest_presence_20260531/SUMMARY.md`
...
sed -n '1,120p' reports/runs/evaluations/stage1_yolo26s_reviewed_test_presence_error_candidates_20260531/SUMMARY.md
sed -n '1,120p' reports/runs/evaluations/predictions_manifest_presence_20260531/SUMMARY.md
```
