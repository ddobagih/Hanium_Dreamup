...
- 작성일: 2026-07-02 KST
- 범위: local/mock/static/headless/integration/Android build 검증 근거 색인
- 제외: 실제 전화/SMS, 실제 LLM/Cloud NLU, 운영 배포, 외부 기관 제출, destructive retention, Android field 완료 주장

## 핵심 evidence

| Evidence | 경로 | 범위 |
|---|---|---|
| Current status | `docs/current_status.md` | 2026-07-02 현재 상태/source-of-truth |
...
| Feature matrix | `docs/evidence/feature_matrix.md` | 240개 항목 evidence 등급/상태 + Android addendum |
...
| Report operations | `docs/report_operations.md` | 신고/검수/export/제출 전 정책 |
...
- live TMAP 자동 재탐색은 Android 주경로가 아니며 후순위다.
