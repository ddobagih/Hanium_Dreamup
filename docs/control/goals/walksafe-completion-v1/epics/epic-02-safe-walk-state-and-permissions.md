...
next_goal_id = "WS-GOAL-A-EPIC-03"
...
현재 Work Item은 [`../work-items/a/epic-02-fp018-walk-state-recovery-r001.md`](../work-items/a/epic-02-fp018-walk-state-recovery-r001.md)다. 각 Work Item은 완료 뒤 이 EPIC으로 돌아온다. 모든 행이 완료되면 [`epic-03-account-admin-security.md`](epic-03-account-admin-security.md)를 자동 시작한다.
