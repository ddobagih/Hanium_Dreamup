...
next_goal_id = "WS-GOAL-A-EPIC-06"
...
정책 문구와 안전 우선순위는 다시 묻지 않는다. 실제 임계값을 공식 지원 기기 측정 없이 정해야 한다면 보수적 비활성 기본값을 유지하고 Phase B 측정으로 넘긴다.

## 완료 후 인계

완료 뒤 [`epic-06-voice-haptic-accessibility.md`](epic-06-voice-haptic-accessibility.md)를 자동 시작한다.
