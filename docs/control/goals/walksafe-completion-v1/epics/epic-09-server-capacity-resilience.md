...
next_goal_id = "WS-GOAL-A-EPIC-11"
return_goal_id = "WS-GOAL-PHASE-A"
work_item_id = ""
dependencies = ["WS-GOAL-A-EPIC-03", "WS-GOAL-A-EPIC-07", "WS-GOAL-A-EPIC-08"]
child_goal_ids = []
...
완료 뒤 [`epic-11-release-operations-recovery-readiness.md`](epic-11-release-operations-recovery-readiness.md)를 자동 시작한다.
