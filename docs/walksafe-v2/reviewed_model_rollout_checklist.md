...
```bash
OUT_DIR=reports/runs/evaluations/walksafe_tactile3_reviewed_yolo26s_20260523 \
...
python3 scripts/evaluate_yolo_image_level_presence_20260523.py \
  ...
  --out-json reports/runs/evaluations/walksafe_tactile3_reviewed_yolo26s_20260523/image_level_damaged_tactile_block.json
```
...
- trace 목적은 기관 자동 API 제출이 아니라 관리자 내부 검수와 CSV 다운로드 후 수동 외부 신고 흐름 검증이다.
