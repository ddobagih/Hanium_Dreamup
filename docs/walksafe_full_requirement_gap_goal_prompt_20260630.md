...
- Source documents: `docs/walksafe_implementation_plan_20260630.html`, `docs/current_status.md`, `product/done-criteria.md`, `product/backlog.md`, `product/decisions.md`, Android docs, `docs/walksafe-v2/*`, `docs/evidence/*`.
...
참고 기준:
- docs/walksafe_implementation_plan_20260630.html
- docs/walksafe_full_requirement_gap_goal_prompt_20260630.md
...
1. README, apps/android/README.md, docs/current_status.md, docs/evidence/*, docs/android/android_native_mvp_evidence_20260630.md, HTML 계획서 상태를 최신 코드 기준으로 일치시킨다.
