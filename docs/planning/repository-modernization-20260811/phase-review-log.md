...
- 첫 게시 commit `09ac73baf0d43dce98586815272a7cb18015f14f`의 quality run `31552434669`은 기본 shallow checkout에 FP046 compatibility binding의 source commit `1e976419dc98a2ee336c02e1d08ccbd62e4625c0` 객체가 없어 active-session-control 3건이 실패했다. 검증을 약화하거나 전체 이력을 받지 않고, workflow가 이 exact commit 하나만 depth 1로 가져와 commit object를 확인한 뒤 control tests를 실행하도록 보완했다.
