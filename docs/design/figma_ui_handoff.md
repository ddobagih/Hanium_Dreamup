...
> [!WARNING]
> **HISTORICAL / PWA-v1 handoff (2026-05-12).** 아래 화면/API 표는 v1 PWA 설계 기록이다. 최신 구현 상태는 [`implementation_audit_20260710.md`](../status/implementation_audit_20260710.md)와 [`current_status.md`](../status/current_status.md), Android 연구 경로는 [`apps/android/README.md`](../../apps/android/README.md), Web v2 정책은 [`frontend_display_policy.md`](../walksafe-v2/frontend_display_policy.md)를 우선한다. 현재 v2 신고는 GPS가 있어야 저장하며 낮은 정확도는 review flag로 남긴다.
...
- `docs/design/DESIGN.md`: 색상, 타이포그래피, 접근성, 모바일 우선 원칙
- `docs/design/ui_feature_inventory.md`: 현재 구현/예정 기능 범위
- `_archive_candidates/2026-07-08/docs/inference_contract.md`: v1 legacy 탐지 이벤트 계약 참고
- `docs/frontend_api_examples.md`: API 요청 예시
- `docs/backend/backend_error_contract.md`: 오류 처리 기준
...
Design source: docs/design/DESIGN.md
API contract: docs/walksafe-v2/backend_api_contract.md
...
`docs/design/DESIGN.md`의 토큰을 기준으로 한다.
...
docs/design/DESIGN.md 기준으로 고대비, 모바일 우선, 낮은 인지부하, 48px 이상 터치 영역을 지켜줘.
...
6. `docs/design/DESIGN.md` 색상/타이포그래피/터치 영역 기준을 따른다.
