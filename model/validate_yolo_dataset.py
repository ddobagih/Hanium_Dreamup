#!/usr/bin/env python3
"""Validate a three-split YOLO dataset without third-party dependencies."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate a YOLO dataset that provides train, val, and test directories."
    )
    parser.add_argument(
        "--data",
        required=True,
        help="Path to the YOLO data.yaml file. No dataset is selected implicitly.",
    )
