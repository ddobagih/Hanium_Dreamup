#!/usr/bin/env python3
"""Run the signed FP008 seq47c isolated-snapshot corrective reconcile."""
...
ENGINE_PRIVATE_MODULE_PREFIX = "_walksafe_fp008_seq47c_reconcile_engine_"
...
FROZEN_SCRIPT_SOURCES = {
    ...
    "scripts/materialize_walksafe_fp008_goal_seq45_46_20260803.py": (
        "06fc88fc46bb6095a70a7b3ebf12a3ee88a9b8f37a7961e9800fadb5e2a15df6",
        57_088,
    ),
...
_ENGINE_CONFIGURATION = {
    ...
    "ADDED_AUTHORITY_OPERATION": (
        "walksafe.fp008.seq47c-isolated-snapshot-fix-reconcile.v1"
    ),
    ...
    "REVIEWER_PUBLIC_KEY_SPKI_DER_BASE64": (
        "MCowBQYDK2VwAyEAcD0Xbj9O9hxB1rICVibXW68kkkuySTZ41jFhOvQTrGQ="
    ),
    "REVIEWER_PUBLIC_KEY_SPKI_SHA256": (
        "06313927fd3d6adaac80c73aed9d32c780d9029875a40877d350d540ba7103f7"
    ),
    "REVIEWER_PUBLIC_KEY_SPKI_BYTE_COUNT": 44,
    "ED25519_SIGNATURE_BYTE_COUNT": 64,
    "SOURCE_CHECKPOINT_SHA256": (
        "66ed58822eb3b498201e36b367a1117dc64ddcff99c323d0c3e6b909e5ff9fc5"
    ),
    "SOURCE_CHECKPOINT_BYTE_COUNT": 1_531_758,
    "SOURCE_SEQUENCE": 47,
    "SOURCE_EVENT_SHA256": (
        "82ad77e33eaa55530f53f5ee315807ef66e21fbfc8be2511b004abe99505db90"
    ),
    "SOURCE_CONTENT_SET_SHA256": (
        "543fabdb557e58b4485123910efd0b5b4b96dd0b9cb4d5a3be2c6f3ade5cf677"
    ),
    "MANAGED_PATH_COUNT": 629,
    "PATH_SET_SHA256": (
        "62b6f428ac4c7e3b27843e77a9b2fca77cf09a97910fcf3dc357dc0dfb28ea75"
    ),
...
with zipfile.ZipFile(io.BytesIO(raw), "r") as archive:
    ...
    if (
        len(manifest_raw) != 3856
        or hashlib.sha256(manifest_raw).hexdigest()
        != "9755cb11635e034cb8cba644a068fca36d7236e81c2d7363de5bd323f82874a3"
    ):
