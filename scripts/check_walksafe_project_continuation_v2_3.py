#!/usr/bin/env python3
"""Validate the immutable baseline and the WalkSafe v2.3 handoff checkpoint."""
...
EXPECTED_CHECKPOINT_SCHEMA_VERSION = "1.14.0"
EXPECTED_CHECKPOINT_AS_OF = "2026-07-24"
EXPECTED_ACTIVE_GOAL_PACKAGE_ID = (
    "WS-GOAL-PACKAGE-WALKSAFE-COMPLETION-GRAPH-V2-3"
)
EXPECTED_ACTIVE_GOAL_SCHEMA_VERSION = "2.1"
EXPECTED_ACTIVE_GOAL_PLAN_VERSION = "2.3.0"
EXPECTED_ACTIVE_GOAL_MASTER_ID = "WS-GOAL-WALKSAFE-COMPLETION-GRAPH-V2"
EXPECTED_ACTIVE_GOAL_FOCUS_ID = "WS-GOAL-EPIC-02-FP-005-R001"
EXPECTED_ACTIVE_GOAL_READY_FRONTIER = (
...
EXPECTED_CURRENT_GOAL_ID = "WS-GOAL-EPIC-02-FP-006-R001"
EXPECTED_CURRENT_GOAL_WORK_ITEM_ID = (
    "EPIC-02-FP006-SOLO-WALK-PHONE-MOUNTING"
)
EXPECTED_CURRENT_GOAL_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/work-items/epic-02/"
    "epic-02-fp006-solo-walk-phone-mounting-r001.md"
)
EXPECTED_CURRENT_GOAL_READY_FRONTIER = (
    EXPECTED_CURRENT_GOAL_ID,
    "WS-GOAL-EPIC-03",
    "WS-GOAL-EPIC-12",
)
EXPECTED_FP010_GOAL_ID = "WS-GOAL-EPIC-02-FP-010-R001"
EXPECTED_FP010_GOAL_WORK_ITEM_ID = "EPIC-02-FP010-FIRST-RUN-REGISTRATION"
EXPECTED_FP010_GOAL_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/work-items/epic-02/"
    "epic-02-fp010-first-run-registration-r001.md"
)
EXPECTED_FP010_GOAL_READY_FRONTIER = (
    EXPECTED_FP010_GOAL_ID,
    "WS-GOAL-EPIC-03",
    "WS-GOAL-EPIC-12",
)
EXPECTED_FP011_GOAL_ID = "WS-GOAL-EPIC-02-FP-011-R001"
EXPECTED_FP011_GOAL_WORK_ITEM_ID = "EPIC-02-FP011-LONG-LIVED-LOGIN"
EXPECTED_FP011_GOAL_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/work-items/epic-02/"
    "epic-02-fp011-long-lived-login-r001.md"
)
EXPECTED_FP011_GOAL_READY_FRONTIER = (
    EXPECTED_FP011_GOAL_ID,
    "WS-GOAL-EPIC-03",
    "WS-GOAL-EPIC-12",
)
EXPECTED_FP005_GOAL_ID = "WS-GOAL-EPIC-02-FP-005-R001"
EXPECTED_FP005_GOAL_CONTENT_SHA256 = (
    "61742bc14a794592978c788b9600db1e1e7185edaa6e6413d37fc49cca286a21"
)
EXPECTED_FP005_COMPLETION_ROLE = (
    "WORK_ITEM_COMPLETION::WS-GOAL-EPIC-02-FP-005-R001"
)
EXPECTED_FP005_COMPLETION_RECEIPT_ID = (
    "WS-FP005-OFFICIAL-ENVIRONMENT-WORK-ITEM-COMPLETION-20260724-001"
)
EXPECTED_FP005_COMPLETION_RECEIPT_PATH = (
    "docs/control/execution/goal-results/"
    "WS-GOAL-EPIC-02-FP-005-R001/completion-receipt.json"
)
EXPECTED_FP005_COMPLETION_RECEIPT_SHA256 = (
    "2b2cefc069dee597e12ad26c51d9a2d78480a5050bb2eaaf1a29551fb2e422b8"
)
EXPECTED_R012_GAP_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-gap-analysis-20260724-r012.json"
)
EXPECTED_R012_GAP_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-GAP-ANALYSIS-20260724-012"
)
EXPECTED_R012_GAP_FILE_SHA256 = (
    "28465bfb026c5de8ed0aa5752c3b532e3cb0a99329060acfa8618ba97f1ef27b"
)
EXPECTED_R012_BACKLOG_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260724-r012.json"
)
EXPECTED_R012_BACKLOG_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260724-012"
)
EXPECTED_R012_BACKLOG_FILE_SHA256 = (
    "305e7864f021575ce04aec39bcbb5ba968e2299e4afcf7287712283c12c31fe3"
)
EXPECTED_FP006_COMPLETION_ROLE = (
    "WORK_ITEM_COMPLETION::WS-GOAL-EPIC-02-FP-006-R001"
)
EXPECTED_FP006_COMPLETION_RECEIPT_ID = (
    "WS-FP006-PHONE-MOUNTING-WORK-ITEM-COMPLETION-20260724-001"
)
EXPECTED_FP006_COMPLETION_RECEIPT_PATH = (
    "docs/control/execution/goal-results/"
    "WS-GOAL-EPIC-02-FP-006-R001/completion-receipt.json"
)
EXPECTED_R013_GAP_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-gap-analysis-20260724-r013.json"
)
EXPECTED_R013_GAP_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-GAP-ANALYSIS-20260724-013"
)
EXPECTED_R013_BACKLOG_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260724-r013.json"
)
EXPECTED_R013_BACKLOG_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260724-013"
)
EXPECTED_FP010_COMPLETION_ROLE = (
    "WORK_ITEM_COMPLETION::WS-GOAL-EPIC-02-FP-010-R001"
)
EXPECTED_FP010_COMPLETION_RECEIPT_ID = (
    "WS-FP010-FIRST-RUN-REGISTRATION-WORK-ITEM-COMPLETION-20260725-001"
)
EXPECTED_FP010_COMPLETION_RECEIPT_PATH = (
    "docs/control/execution/goal-results/"
    "WS-GOAL-EPIC-02-FP-010-R001/completion-receipt.json"
)
EXPECTED_R014_GAP_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-gap-analysis-20260725-r014.json"
)
EXPECTED_R014_GAP_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-GAP-ANALYSIS-20260725-014"
)
EXPECTED_R014_BACKLOG_PATH = (
    "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260725-r014.json"
)
EXPECTED_R014_BACKLOG_DOCUMENT_ID = (
    "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260725-014"
)
EXPECTED_V23_LEGAL_TAIL_EVENT_TYPES = (
    "PACKAGE_PREPARED",
    "PACKAGE_ACTIVATED",
    "GOAL_STARTED",
...
EXPECTED_V23_FP010_TRANSITION_EVENT_TYPES = (
    "CANONICAL_BINDINGS_UPDATED",
    "GOAL_COMPLETED",
    "GOAL_MATERIALIZED",
    "GOAL_READY",
)
EXPECTED_V23_FP011_TRANSITION_EVENT_TYPES = (
    "CANONICAL_BINDINGS_UPDATED",
    "GOAL_COMPLETED",
    "GOAL_MATERIALIZED",
    "GOAL_READY",
)
EXPECTED_V23_ACTIVATION_EVENT_SHA256 = (
    "e2fdbadd4ba696627806e816236d57d70168f81c317726819d1ddb2cc2584ba1"
)
EXPECTED_V23_START_GATE_CONTRACT_VERSION = "2026-07-24.3"
EXPECTED_V23_START_GATE_CONTRACT_SHA256 = (
    "a8a7fc6e0bd88585a73684b46ca3e9ca1ddabadfc2ae7bd293f28d5839bcbd4c"
)
EXPECTED_ACTIVE_GOAL_MANIFEST_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "static-plan-manifest-v2.3.0.json"
)
FINALIZE_EXPECTED_ACTIVE_GOAL_MANIFEST_SHA256 = (
    "dfa615686b0223826497fae424c1f3c41538b271102879a9497a33b81f66329c"
)
FINALIZE_EXPECTED_GOAL_INITIAL_EVENT_SHA256 = (
    "3e2a585a8224527c5c732c3ac39cfc13fb35ed85613a1f97a0295339c71170ef"
)
# The working snapshot content-set hash is intentionally not duplicated here:
# this checker is itself a managed path, so the finalized hash belongs only in
# working_tree_snapshot after every v2.3 file and trust anchor is byte-final.
...
V23_LIFECYCLE_STATUS_PAIRS = {
    ("READY_NOT_ACTIVATED", "PREPARED_NOT_ACTIVATED"),
    ("ACTIVE", "ACTIVE"),
    ("COMPLETED", "COMPLETED"),
}
V23_ALLOWED_EVENT_TYPES = {
    "PACKAGE_PREPARED",
    "PACKAGE_ACTIVATED",
    "CANONICAL_BINDINGS_UPDATED",
    "GOAL_MATERIALIZED",
...
EXPECTED_V22_GOAL_PACKAGE_ID = (
    "WS-GOAL-PACKAGE-WALKSAFE-COMPLETION-GRAPH-V2-2"
)
EXPECTED_V22_GOAL_PLAN_VERSION = "2.2.0"
EXPECTED_V22_GOAL_MANIFEST_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-2/"
    "static-plan-manifest-v2.2.0.json"
)
EXPECTED_V22_GOAL_MANIFEST_SHA256 = (
    "c761ed6d9ac83fb98a2dded6eb99b639610e67a7bf13bdd306f8be38e996577b"
)
EXPECTED_V22_ARCHIVED_CHECKPOINT_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "superseded-v2.2.0-active-checkpoint.json"
)
EXPECTED_V22_ARCHIVED_CHECKPOINT_SHA256 = (
    "c15d677c9d8f9b68227cb0b2ffaac3aef4794e2bdb031b8cc4ca4a4790fc6024"
)
EXPECTED_V22_SUPERSESSION_RECORD_PATH = (
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "active-supersession-record-v2.2.0.json"
)
EXPECTED_V22_TRANSITION_EVENT_COUNT = 20
EXPECTED_V22_TRANSITION_HISTORY_ANCHOR_SHA256 = (
    "ec531638c3b3ce68b611e198dba06f6703d837aa712d6aae403f212f8272030d"
)
EXPECTED_FROZEN_V22_CONTINUATION_CHECKER_PATH = (
    "scripts/check_walksafe_project_continuation.py"
)
EXPECTED_FROZEN_V22_CONTINUATION_CHECKER_SHA256 = (
    "c980ea32e08809a299e0b75d6110f81a8996ca4fa523dba7639f8b9136238499"
)
EXPECTED_FROZEN_V22_CONTINUATION_TEST_PATH = (
    "tests/test_walksafe_project_continuation.py"
)
EXPECTED_FROZEN_V22_CONTINUATION_TEST_SHA256 = (
    "c972fbf39e2bec5de5d84082441a3f3bf85410c82015692c4c7a45804fa298ff"
)
EXPECTED_V22_PACKAGE_MANAGED_PATH_COUNT = 23
EXPECTED_V22_PACKAGE_PATH_SET_SHA256 = (
    "1afe2adca0413a03b073f0c7f777625872153fcadce2eccfca286142dbfe3398"
)
EXPECTED_V22_PACKAGE_CONTENT_SET_SHA256 = (
...
EXPECTED_VERIFICATION_COMMANDS = {
    ...
    "FP005_TRACE": {
        "status": "PASS",
        "command": "python3 -B scripts/build_walksafe_fp005_official_environment_trace_20260724.py --check && <locked-python> -m pytest tests/test_walksafe_fp005_official_environment_trace_20260724.py -q",
        "result_required_fragments": (
            "10/10",
            "GAP-014=PARTIAL",
            "FP-006/GAP-015",
            "formal=279/279 NOT_RUN",
            "environment-field=NOT_RUN",
            "actual-user=NOT_RUN",
            "actual-device=NOT_RUN",
            "approved-production-profile=0",
            "NOT_ELIGIBLE",
        ),
    },
    "UNIT_LAYER_PHASE_F": {
    ...
    "GOAL_PACKAGE": {
        "status": "PASS",
        "command": "python3 -B scripts/check_walksafe_goal_graph_v2_3.py && /home/ddobagi/.local/share/hanium-dreamup/walksafe-general-cpu-verify-20260715/bin/python -m pytest tests/test_walksafe_goal_graph_v2_3.py tests/test_walksafe_project_continuation_v2_3.py tests/test_walksafe_goal_graph_v2_2_history.py -q",
        "result_required_fragments": (
            "고정 단계 수 없음",
            "의존성 DAG",
            "ready frontier",
...
EXPECTED_FP005_SUCCESSOR_STALE_VERIFICATION = {
    "status": "EXPECTED_STALE",
    "command": (
        "python3 -B scripts/"
        "build_walksafe_fp005_official_environment_trace_20260724.py --check "
        "&& <locked-python> -m pytest "
        "tests/test_walksafe_fp005_official_environment_trace_20260724.py -q"
    ),
    "result": (
        "FP-006 successor가 canonical Gap·Backlog와 Android 통제 경로를 변경해 "
        "FP-005 live trace 재생성은 EXPECTED_STALE; 과거 증거는 불변 receipt와 "
        "transition history로 보존"
    ),
}
EXPECTED_FP006_TRACE_VERIFICATION = {
    "status": "PASS",
    "command": (
        "python3 -B scripts/build_walksafe_fp006_phone_mounting_trace_20260724.py "
        "--check && <locked-python> -m pytest "
        "tests/test_walksafe_fp006_phone_mounting_trace_20260724.py -q"
    ),
    "result_required_fragments": (
        "10/10 PASS",
        "GAP-015=PARTIAL",
...
def expected_verification_commands(
    fp010_successor_active: bool,
) -> dict[str, dict[str, Any]]:
    expected = dict(EXPECTED_VERIFICATION_COMMANDS)
    if fp010_successor_active:
        expected["FP005_TRACE"] = EXPECTED_FP005_SUCCESSOR_STALE_VERIFICATION
        expected["FP006_TRACE"] = EXPECTED_FP006_TRACE_VERIFICATION
    return expected
...
EXPECTED_NEXT_WORK_ITEM_ID = "EPIC-02-FP006-SOLO-WALK-PHONE-MOUNTING"
EXPECTED_NEXT_SOURCE_POLICY_ID = "FP-006"
EXPECTED_NEXT_GAP_ID = "GAP-015"
EXPECTED_NEXT_ACTION = (
    "가슴·목걸이형 정면 장착, 가림·흔들림·각도 품질과 기존 보조수단 비대체 "
    "고지를 Android 사전점검·안전정지에 연결한다."
)
EXPECTED_FP010_NEXT_WORK_ITEM_ID = EXPECTED_FP010_GOAL_WORK_ITEM_ID
EXPECTED_FP010_NEXT_SOURCE_POLICY_ID = "FP-010"
EXPECTED_FP010_NEXT_GAP_ID = "GAP-019"
EXPECTED_FP010_NEXT_ACTION = (
    "연령 확인, 전화번호 확인, 가입, 통합 동의, 권한, 사용훈련을 순서가 있는 "
    "첫 실행 상태기계로 구현한다."
)
EXPECTED_FP011_NEXT_WORK_ITEM_ID = EXPECTED_FP011_GOAL_WORK_ITEM_ID
EXPECTED_FP011_NEXT_SOURCE_POLICY_ID = "FP-011"
EXPECTED_FP011_NEXT_GAP_ID = "GAP-020"
EXPECTED_FP011_NEXT_ACTION = (
    "Android 보안 저장소 기반 접근용·회전 갱신용 로그인 증명과 "
    "만료·재발급·재사용 탐지·기기별 원격 폐기를 구현한다."
)
EXPECTED_LAST_COMPLETED_WORK_SUMMARY = (
    ...
    "FP-004 우선 사용자와 필수 사전연습·"
    "FP-005 공식 사용환경과 횡단보도의 내부 검증"
)
EXPECTED_CURRENT_FOCUS = (
    "구현 백로그 EPIC-02 상태 IN_PROGRESS·graph Workstream WS-GOAL-EPIC-02 상태 READY — "
    "FP-005 공식 사용환경과 횡단보도 내부 검증 완료, "
    "다음 정책·Gap FP-006/GAP-015 준비 또는 진행"
)
EXPECTED_FP010_LAST_COMPLETED_WORK_SUMMARY = (
    EXPECTED_LAST_COMPLETED_WORK_SUMMARY
    + "·FP-006 휴대전화 장착 관문·교정·안전정지 내부 구현"
)
EXPECTED_FP010_CURRENT_FOCUS = (
    "구현 백로그 EPIC-02 상태 IN_PROGRESS·graph Workstream WS-GOAL-EPIC-02 상태 READY — "
    "FP-006/GAP-015 내부 구현과 재평가 완료, "
    "다음 정책·Gap FP-010/GAP-019 READY"
)
EXPECTED_FP011_LAST_COMPLETED_WORK_SUMMARY = (
    EXPECTED_FP010_LAST_COMPLETED_WORK_SUMMARY
    + "·FP-010 첫 실행 가입 상태기계 내부 구현"
)
EXPECTED_FP011_CURRENT_FOCUS = (
    "구현 백로그 EPIC-02 상태 IN_PROGRESS·graph Workstream WS-GOAL-EPIC-02 상태 READY — "
    "FP-010/GAP-019 내부 구현과 재평가 완료, "
    "다음 정책·Gap FP-011/GAP-020 READY"
)

EXPECTED_R012_STATUS_COUNTS = {
    "BLOCKED": 5,
    "CONFLICTING": 18,
    "EVIDENCE_MISSING": 4,
    "MISSING": 17,
...
EXPECTED_CHECKPOINT_STATUS_COUNTS = dict(EXPECTED_R012_STATUS_COUNTS)
...
EXPECTED_SUCCESSOR_CANONICAL_BINDINGS = {
    ...
    "IMPLEMENTATION_GAP": {
        "path": "docs/control/audits/walksafe-implementation-gap-analysis-20260724-r012.json",
        "document_id": "WS-IMPLEMENTATION-GAP-ANALYSIS-20260724-012",
        "identity_json_path": "metadata.report_id",
        "mutable": False,
    },
    "IMPLEMENTATION_BACKLOG": {
        "path": "docs/control/audits/walksafe-implementation-remediation-backlog-20260724-r012.json",
        "document_id": "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260724-012",
        "identity_json_path": "metadata.backlog_id",
        "mutable": False,
    },
    EXPECTED_FP005_COMPLETION_ROLE: {
        "path": EXPECTED_FP005_COMPLETION_RECEIPT_PATH,
        "document_id": EXPECTED_FP005_COMPLETION_RECEIPT_ID,
...
EXPECTED_FP005_IMPLEMENTATION_PATHS = (
    "apps/android/app/src/main/java/kr/co/hanium/dreamup/walksafe/MainActivity.kt",
...
EXPECTED_FP005_TRACE_PATHS = (
    ...
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/logs/focused-android-tests.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/logs/full-android-verification.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/logs/control-plane-successor-chain-verification.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/implementation-record.json",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/verification-result.json",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/successor-trace.json",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-005-R001/independent-review.json",
    EXPECTED_FP005_COMPLETION_RECEIPT_PATH,
    "docs/control/audits/walksafe-implementation-gap-analysis-20260724-r012.json",
    "docs/control/audits/walksafe-implementation-gap-analysis-20260724-r012.md",
    "docs/control/audits/walksafe-implementation-remediation-backlog-20260724-r012.json",
    "docs/control/audits/walksafe-implementation-remediation-backlog-20260724-r012.md",
    "docs/control/execution/walksafe-epic-02-fp005-official-environment-crosswalk-active-ledger-overlay-20260724-r001.json",
    "docs/control/execution/walksafe-epic-02-fp005-official-environment-crosswalk-active-ledger-overlay-20260724-r001.md",
)

EXPECTED_FP006_IMPLEMENTATION_PATHS = (
    "apps/android/USER_GUIDE.md",
    "apps/android/app/src/main/java/kr/co/hanium/dreamup/walksafe/MainActivity.kt",
...
EXPECTED_FP006_COMPLETION_OUTPUT_PATHS = (
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-006-R001/"
    ...
    EXPECTED_FP006_COMPLETION_RECEIPT_PATH,
    EXPECTED_R013_GAP_PATH,
    "docs/control/audits/walksafe-implementation-gap-analysis-20260724-r013.md",
    EXPECTED_R013_BACKLOG_PATH,
    "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260724-r013.md",
    "docs/control/execution/"
    "walksafe-epic-02-fp006-solo-walk-phone-mounting-active-ledger-"
    "overlay-20260724-r001.json",
    "docs/control/execution/"
    "walksafe-epic-02-fp006-solo-walk-phone-mounting-active-ledger-"
    "overlay-20260724-r001.md",
)

EXPECTED_FP006_VERIFICATION_LOG_PATHS = (
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-006-R001/"
    "logs/focused-android-tests.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-006-R001/"
    "logs/full-android-verification.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-006-R001/"
    "logs/control-plane-verification.log",
)

EXPECTED_FP006_TRACE_TOOL_PATHS = (
    "scripts/build_walksafe_fp006_phone_mounting_trace_20260724.py",
    "tests/test_walksafe_fp006_phone_mounting_trace_20260724.py",
)

EXPECTED_FP010_IMPLEMENTATION_PATHS = (
...
EXPECTED_FP010_COMPLETION_OUTPUT_PATHS = (
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-010-R001/"
    "implementation-record.json",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-010-R001/"
    "verification-result.json",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-010-R001/"
    ...
    EXPECTED_FP010_COMPLETION_RECEIPT_PATH,
    EXPECTED_R014_GAP_PATH,
    "docs/control/audits/walksafe-implementation-gap-analysis-20260725-r014.md",
    EXPECTED_R014_BACKLOG_PATH,
    "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260725-r014.md",
    "docs/control/execution/"
    "walksafe-epic-02-fp010-first-run-registration-active-ledger-"
    "overlay-20260725-r001.json",
    "docs/control/execution/"
    "walksafe-epic-02-fp010-first-run-registration-active-ledger-"
    "overlay-20260725-r001.md",
)

EXPECTED_FP010_VERIFICATION_LOG_PATHS = (
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-010-R001/"
    "logs/focused-android-tests.log",
    "docs/control/execution/goal-results/WS-GOAL-EPIC-02-FP-010-R001/"
    "logs/full-android-verification.log",
...
EXPECTED_FP010_TRACE_TOOL_PATHS = (
...
EXPECTED_FROZEN_V22_GOAL_PACKAGE_PATHS = (
    ...
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/epic-02-fp004-priority-user-r001.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/epic-02-fp005-official-environment-crosswalk-r001.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/epic-02-fp018-walk-state-recovery-r001.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/epic-02-npc-permission-session-lifecycle-r001.md",
...
EXPECTED_V23_IMPORTED_GOAL_PATHS = (
    "docs/control/goals/walksafe-completion-graph-v2-2/00-master-goal.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/"
    "epic-02-fp004-priority-user-r001.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/work-items/epic-02/"
    ...
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-06-voice-haptic-accessibility.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-07-raw-data-lifecycle.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-08-auto-report-queue.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-09-server-capacity-resilience.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-10-ai-model-lifecycle.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-11-release-operations-recovery-readiness.md",
    "docs/control/goals/walksafe-completion-graph-v2-2/workstreams/"
    "epic-12-formal-verification-gates.md",
)

EXPECTED_V23_NATIVE_PACKAGE_PATHS = (
    "docs/control/goals/walksafe-completion-graph-v2-3/README.md",
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "active-supersession-record-v2.2.0.json",
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "static-plan-manifest-v2.3.0.json",
    "docs/control/goals/walksafe-completion-graph-v2-3/"
    "superseded-v2.2.0-active-checkpoint.json",
    "docs/control/goals/walksafe-completion-graph-v2-3/templates/"
    "dynamic-node-template.md",
    "docs/control/goals/walksafe-completion-graph-v2-3/templates/"
    "policy-gap-work-item.md",
)

EXPECTED_SEQ8_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS = (
    EXPECTED_CURRENT_GOAL_PATH,
)

EXPECTED_SEQ13_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS = (
    *EXPECTED_SEQ8_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS,
    EXPECTED_FP010_GOAL_PATH,
)

EXPECTED_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS = (
    *EXPECTED_SEQ13_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS,
    EXPECTED_FP011_GOAL_PATH,
)

EXPECTED_SEQ8_GOAL_PACKAGE_PATHS = tuple(
    sorted(
        set(EXPECTED_V23_IMPORTED_GOAL_PATHS)
        | set(EXPECTED_V23_NATIVE_PACKAGE_PATHS)
        | set(EXPECTED_SEQ8_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS)
    )
)

EXPECTED_SEQ13_GOAL_PACKAGE_PATHS = tuple(
    sorted(
        set(EXPECTED_V23_IMPORTED_GOAL_PATHS)
        | set(EXPECTED_V23_NATIVE_PACKAGE_PATHS)
        | set(EXPECTED_SEQ13_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS)
    )
)

EXPECTED_GOAL_PACKAGE_PATHS = tuple(
    sorted(
        set(EXPECTED_V23_IMPORTED_GOAL_PATHS)
        | set(EXPECTED_V23_NATIVE_PACKAGE_PATHS)
        | set(EXPECTED_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS)
    )
)

EXPECTED_GOAL_TOOL_PATHS = (
...
EXPECTED_SEQ8_CONTROLLED_PATHS = tuple(
    sorted(
        ...
        | set(EXPECTED_FP005_IMPLEMENTATION_PATHS)
        | set(EXPECTED_FP005_TRACE_PATHS)
        ...
        | set(EXPECTED_FROZEN_V22_GOAL_PACKAGE_PATHS)
        | set(EXPECTED_SEQ8_GOAL_PACKAGE_PATHS)
        | set(EXPECTED_CURRENT_DYNAMIC_GOAL_PATHS)
        | set(EXPECTED_GOAL_TOOL_PATHS)
        | {"daylog/2026-07-23.md", "daylog/2026-07-24.md"}
    )
)
EXPECTED_SEQ8_CONTROLLED_PATH_COUNT = 444
EXPECTED_SEQ8_CONTROLLED_PATH_SET_SHA256 = (
    "2a5cea18cf4b07265c282f2f71de44af91cd6ed075e77340a4cf223e6226c7dc"
)
EXPECTED_SEQ13_CONTROLLED_PATHS = tuple(
    sorted(
        set(EXPECTED_SEQ8_CONTROLLED_PATHS)
        | set(EXPECTED_FP006_IMPLEMENTATION_PATHS)
        | set(EXPECTED_FP006_COMPLETION_OUTPUT_PATHS)
        | set(EXPECTED_FP006_VERIFICATION_LOG_PATHS)
        | set(EXPECTED_FP006_TRACE_TOOL_PATHS)
        | {EXPECTED_FP010_GOAL_PATH}
        | {"daylog/2026-07-25.md"}
    )
)
EXPECTED_SEQ13_CONTROLLED_PATH_COUNT = len(EXPECTED_SEQ13_CONTROLLED_PATHS)
EXPECTED_SEQ13_CONTROLLED_PATH_SET_SHA256 = hashlib.sha256(
    ("\n".join(EXPECTED_SEQ13_CONTROLLED_PATHS) + "\n").encode("utf-8")
).hexdigest()
EXPECTED_FP010_COMPLETION_CONTROLLED_PATHS = tuple(
    sorted(
        set(EXPECTED_SEQ13_CONTROLLED_PATHS)
        | set(EXPECTED_FP010_IMPLEMENTATION_PATHS)
        | set(EXPECTED_FP010_COMPLETION_OUTPUT_PATHS)
        | set(EXPECTED_FP010_VERIFICATION_LOG_PATHS)
        | set(EXPECTED_FP010_TRACE_TOOL_PATHS)
    )
)
EXPECTED_FP010_COMPLETION_CONTROLLED_PATH_COUNT = len(
    EXPECTED_FP010_COMPLETION_CONTROLLED_PATHS
)
EXPECTED_FP010_COMPLETION_CONTROLLED_PATH_SET_SHA256 = hashlib.sha256(
    (
        "\n".join(EXPECTED_FP010_COMPLETION_CONTROLLED_PATHS) + "\n"
    ).encode("utf-8")
).hexdigest()
EXPECTED_CONTROLLED_PATHS = tuple(
    sorted(
        set(EXPECTED_FP010_COMPLETION_CONTROLLED_PATHS)
        | {EXPECTED_FP011_GOAL_PATH}
    )
)
EXPECTED_CONTROLLED_PATH_COUNT = len(EXPECTED_CONTROLLED_PATHS)
EXPECTED_CONTROLLED_PATH_SET_SHA256 = hashlib.sha256(
    ("\n".join(EXPECTED_CONTROLLED_PATHS) + "\n").encode("utf-8")
).hexdigest()
EXPECTED_FP006_COMPLETION_CONTROLLED_PATHS = tuple(
    relative
    for relative in EXPECTED_SEQ13_CONTROLLED_PATHS
    if relative != EXPECTED_FP010_GOAL_PATH
)


def expected_controlled_paths_for_goal_execution(
    ...
    if event_count >= 16:
        return EXPECTED_CONTROLLED_PATHS
    if event_count >= 14:
        return EXPECTED_FP010_COMPLETION_CONTROLLED_PATHS
    if event_count >= 11:
        return EXPECTED_SEQ13_CONTROLLED_PATHS
    if event_count >= 9:
        return EXPECTED_FP006_COMPLETION_CONTROLLED_PATHS
    return EXPECTED_SEQ8_CONTROLLED_PATHS


def path_set_sha256(paths: tuple[str, ...] | list[str]) -> str:
...
def load_goal_manifest(
    ...
    *,
    ...
    if expected_sha256.startswith("__FINALIZE_"):
        errors.append(f"{label} Goal manifest SHA-256 trust anchor is not finalized")
    else:
        require_equal(
            errors,
...
def validate_v23_mixed_owned_goal_package(
    errors: list[str],
    *,
    root: Path,
    manifest: dict[str, Any],
    ...
    support_paths = tuple(sorted(EXPECTED_V23_NATIVE_PACKAGE_PATHS))
    history = goal_execution.get("transition_history")
    event_count = len(history) if isinstance(history, list) else 0
    successor_dynamic_goal_paths = tuple(
        sorted(
            EXPECTED_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS
            if event_count >= 16
            else EXPECTED_SEQ13_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS
            if event_count >= 11
            else EXPECTED_SEQ8_V23_SUCCESSOR_DYNAMIC_GOAL_PATHS
        )
    )
    native_paths = tuple(
        sorted(set(support_paths) | set(successor_dynamic_goal_paths))
    )
    managed_paths = tuple(
        sorted(
            EXPECTED_GOAL_PACKAGE_PATHS
            if event_count >= 16
            else EXPECTED_SEQ13_GOAL_PACKAGE_PATHS
            if event_count >= 11
            else EXPECTED_SEQ8_GOAL_PACKAGE_PATHS
        )
    )
    imported_paths = tuple(sorted(EXPECTED_V23_IMPORTED_GOAL_PATHS))
    goal_document_paths = tuple(
        sorted(set(imported_paths) | set(successor_dynamic_goal_paths))
    )
    require_equal(
        errors,
        "active v2.3 imported predecessor Goal contract",
        manifest.get("imported_predecessor_goal_contract"),
        {
            "source_package_id": EXPECTED_V22_GOAL_PACKAGE_ID,
            "source_plan_version": EXPECTED_V22_GOAL_PLAN_VERSION,
            "source_checkpoint_path": EXPECTED_V22_ARCHIVED_CHECKPOINT_PATH,
    ...
    try:
        actual_native_paths = package_regular_file_paths(
            root,
            "docs/control/goals/walksafe-completion-graph-v2-3",
        )
    except (OSError, RuntimeError, ValueError) as exc:
        errors.append(f"active v2.3 native package inventory cannot be read: {exc}")
        actual_native_paths = ()
    require_equal(
        errors,
        "active v2.3 native package path inventory",
        list(actual_native_paths),
        list(native_paths),
    )

    protected_files = manifest.get("protected_files")
    if not isinstance(protected_files, list):
        errors.append("active v2.3 protected_files must be a list")
        protected_files = []
    protected_by_path: dict[str, str] = {}
    for index, record in enumerate(protected_files):
        if not isinstance(record, dict):
            errors.append(f"active v2.3 protected_files[{index}] must be an object")
            continue
        ...
        if (
            ...
            or relative in protected_by_path
        ):
            errors.append(
                f"active v2.3 protected_files[{index}] path/hash is malformed"
            )
            continue
        protected_by_path[relative] = digest
    expected_protected_paths = tuple(
        relative
        for relative in support_paths
        if relative != EXPECTED_ACTIVE_GOAL_MANIFEST_PATH
    )
    require_equal(
        errors,
        "active v2.3 protected file count",
        len(protected_files),
        len(expected_protected_paths),
    )
    require_equal(
        errors,
        "active v2.3 protected path inventory",
        list(protected_by_path),
        list(expected_protected_paths),
    )
    for relative in expected_protected_paths:
        protected = resolve_safe_repo_file(root, relative)
        if protected is None:
            errors.append(f"active v2.3 protected file missing or unsafe: {relative}")
            continue
        require_equal(
            errors,
            f"active v2.3 protected file SHA-256 {relative}",
            sha256_file(protected),
            protected_by_path.get(relative),
        )

    imported_bindings = goal_execution.get("imported_predecessor_goal_bindings")
    if not isinstance(imported_bindings, dict):
        errors.append(
            "active v2.3 imported_predecessor_goal_bindings must be an object"
        )
        imported_bindings = {}
    imported_by_path: dict[str, dict[str, Any]] = {}
    for goal_id, binding in imported_bindings.items():
        if not isinstance(binding, dict):
            errors.append(
                f"active v2.3 imported predecessor binding {goal_id} must be an object"
            )
            continue
        expected_fields = {
            "goal_id",
        ...
        if binding.get("goal_kind") == "WORK_ITEM":
            expected_fields.add("materialized_event_sha256")
        if binding.get("status") == "COMPLETE_AT_TARGET":
            expected_fields.update(
                {"completion_event_sha256", "completion_evidence_refs"}
            )
        require_equal(
            errors,
            f"active v2.3 imported predecessor binding fields {goal_id}",
            set(binding),
            expected_fields,
        )
        relative = binding.get("path")
        if not isinstance(relative, str) or relative in imported_by_path:
            errors.append(
                f"active v2.3 imported predecessor binding {goal_id} path is invalid"
            )
            continue
        require_equal(
            errors,
            f"active v2.3 imported predecessor binding key {goal_id}",
            binding.get("goal_id"),
            goal_id,
        )
        imported_by_path[relative] = binding
    require_equal(
        errors,
        "active v2.3 imported Goal path inventory",
        sorted(imported_by_path),
        list(imported_paths),
    )
    for relative in imported_paths:
        binding = imported_by_path.get(relative, {})
        require_equal(
            errors,
            f"active v2.3 imported Goal source package {relative}",
            binding.get("source_package_id"),
            EXPECTED_V22_GOAL_PACKAGE_ID,
        )
        imported = resolve_safe_repo_file(root, relative)
        if imported is None:
            errors.append(f"active v2.3 imported Goal missing or unsafe: {relative}")
            continue
        require_equal(
            errors,
            f"active v2.3 imported Goal SHA-256 {relative}",
            binding.get("sha256"),
            sha256_file(imported),
        )

    expected_imported_focus = {
        "WS-GOAL-EPIC-02-FP-004-R001": "COMPLETE_AT_TARGET",
        "WS-GOAL-EPIC-02-FP-005-R001": "READY",
    }
    imported_status_by_goal = {
        goal_id: binding.get("status")
        for goal_id, binding in imported_bindings.items()
        if isinstance(binding, dict)
        and isinstance(goal_id, str)
    }
    for goal_id, expected_status in expected_imported_focus.items():
        require_equal(
            errors,
            f"active v2.3 imported {goal_id} status",
            imported_status_by_goal.get(goal_id),
            expected_status,
        )

    for label, actual, expected in (
        (
            "active v2.3 checkpoint managed Goal paths",
            goal_execution.get("managed_goal_paths"),
            list(managed_paths),
        ),
        (
            "active v2.3 checkpoint Goal document paths",
            goal_execution.get("goal_document_paths"),
            list(goal_document_paths),
        ),
        (
            "active v2.3 checkpoint support paths",
            goal_execution.get("support_paths"),
            list(support_paths),
        ),
    ):
    ...
    require_equal(
        errors,
        "active v2.3 managed Goal path count",
        goal_execution.get("managed_goal_path_count"),
        len(managed_paths),
    )
    require_equal(
        errors,
        "active v2.3 Goal document count",
        goal_execution.get("goal_document_count"),
        len(goal_document_paths),
    )
    try:
        path_hash, content_hash = working_snapshot_hashes(root, list(managed_paths))
    except (OSError, RuntimeError, ValueError) as exc:
        errors.append(f"active v2.3 mixed package aggregate cannot be reproduced: {exc}")
    else:
        require_equal(
            errors,
            "active v2.3 package path-set SHA-256",
            goal_execution.get("path_set_sha256"),
            path_hash,
        )
        require_equal(
            errors,
            "active v2.3 package content-set SHA-256",
            goal_execution.get("content_set_sha256"),
            content_hash,
        )


def validate_v22_archived_checkpoint(errors: list[str], root: Path) -> None:
    for label, relative, expected_hash in (
        (
            "superseded v2.2 continuation checker",
            EXPECTED_FROZEN_V22_CONTINUATION_CHECKER_PATH,
            EXPECTED_FROZEN_V22_CONTINUATION_CHECKER_SHA256,
        ),
        (
            "superseded v2.2 continuation test",
            EXPECTED_FROZEN_V22_CONTINUATION_TEST_PATH,
            EXPECTED_FROZEN_V22_CONTINUATION_TEST_SHA256,
        ),
    ):
        frozen = resolve_safe_repo_file(root, relative)
        if frozen is None:
    ...
    archive = resolve_safe_repo_file(root, EXPECTED_V22_ARCHIVED_CHECKPOINT_PATH)
    if archive is None:
        errors.append(
            "superseded v2.2 active checkpoint archive is missing or unsafe"
        )
        return
    require_equal(
        errors,
        "superseded v2.2 active checkpoint archive SHA-256",
        sha256_file(archive),
        EXPECTED_V22_ARCHIVED_CHECKPOINT_SHA256,
    )
    try:
        checkpoint = load_json(archive)
    except (OSError, ValueError, json.JSONDecodeError) as exc:
        errors.append(f"superseded v2.2 checkpoint archive cannot be loaded: {exc}")
        return
    state = checkpoint.get("goal_execution")
    if not isinstance(state, dict):
        errors.append("superseded v2.2 checkpoint goal_execution must be an object")
        return
    require_equal(errors, "superseded v2.2 checkpoint schema", checkpoint.get("schema_version"), "1.13.0")
    require_equal(
        errors,
        "superseded v2.2 checkpoint package ID",
        state.get("package_id"),
        EXPECTED_V22_GOAL_PACKAGE_ID,
    )
    require_equal(
        errors,
        "superseded v2.2 checkpoint plan version",
        state.get("static_plan_version"),
        EXPECTED_V22_GOAL_PLAN_VERSION,
    )
    history = state.get("transition_history")
    require_equal(
        errors,
        "superseded v2.2 transition event count",
        len(history) if isinstance(history, list) else None,
        EXPECTED_V22_TRANSITION_EVENT_COUNT,
    )
    require_equal(
        errors,
        "superseded v2.2 transition history anchor",
        state.get("transition_history_anchor_sha256"),
        EXPECTED_V22_TRANSITION_HISTORY_ANCHOR_SHA256,
    )
    require_equal(
        errors,
        "superseded v2.2 FP004 status",
        state.get("status_by_goal", {}).get("WS-GOAL-EPIC-02-FP-004-R001"),
        "COMPLETE_AT_TARGET",
    )
    require_equal(
        errors,
        "superseded v2.2 FP005 status",
        state.get("status_by_goal", {}).get("WS-GOAL-EPIC-02-FP-005-R001"),
        "READY",
    )


def validate_v23_transition_replay(
    errors: list[str],
    goal_execution: dict[str, Any],
    root: Path,
    ...
    for field in (
        ...
        records = goal_execution.get(field)
        if not isinstance(records, dict):
            continue
        for goal_id, record in records.items():
            if not isinstance(goal_id, str) or not isinstance(record, dict):
                continue
            relative = record.get("path")
            if not isinstance(relative, str):
                continue
            previous = goal_paths.get(goal_id)
            if previous is not None and previous != relative:
                errors.append(
                    f"active Goal path sources disagree for {goal_id}"
                )
            goal_paths[goal_id] = relative
    ...
    for index, event in enumerate(history, start=1):
        label = f"active Goal event {index}"
        ...
        if not object_seal_is_valid(event, "event_sha256"):
            errors.append(f"{label} seal is invalid")
        require_equal(
            errors,
            f"{label} previous event SHA-256",
            event.get("previous_event_sha256"),
            previous_hash,
        )
        require_equal(
            errors,
            f"{label} manifest SHA-256",
            event.get("static_plan_manifest_sha256"),
            active_manifest_hash,
        )

        event_type = event.get("event_type")
        if event_type not in V23_ALLOWED_EVENT_TYPES:
        ...
        if not isinstance(changes, dict):
            ...
            or status not in V23_RUNTIME_STATUSES
            for goal_id, status in changes.items()
        ):
            errors.append(f"{label} status_changes are invalid")

        statuses_before = dict(replay_statuses)
        if index == 1:
            require_equal(
                errors,
                "active Goal initial event type",
                event_type,
                "PACKAGE_PREPARED",
            )
            require_equal(
                errors,
                "active Goal initial event previous event",
                event.get("previous_event_sha256"),
                "",
            )
            require_equal(
                errors,
                "active Goal initial event focus ID",
                event.get("focus_goal_id"),
                EXPECTED_ACTIVE_GOAL_FOCUS_ID,
            )
            require_equal(
                errors,
                "active Goal initial event from status",
                event.get("from_status"),
                "",
            )
            require_equal(
                errors,
                "active Goal initial event to status",
                event.get("to_status"),
                "READY",
            )
            require_equal(
                errors,
                "active Goal initial event supersedes v2.2 transition head",
                event.get("supersedes_event_sha256"),
                EXPECTED_V22_TRANSITION_HISTORY_ANCHOR_SHA256,
            )
            require_equal(
                errors,
                "active Goal prepared FP004 status",
                changes.get("WS-GOAL-EPIC-02-FP-004-R001"),
                "COMPLETE_AT_TARGET",
            )
            require_equal(
                errors,
                "active Goal prepared FP005 status",
                changes.get("WS-GOAL-EPIC-02-FP-005-R001"),
                "READY",
            )
            if (
                EXPECTED_GOAL_INITIAL_EVENT_SHA256.startswith("__FINALIZE_")
                or EXPECTED_GOAL_INITIAL_EVENT_SHA256 == "0" * 64
            ):
                errors.append(
            ...
            if completed:
                errors.append(f"{label} appears after PACKAGE_COMPLETED")
            if event_type == "PACKAGE_PREPARED":
                errors.append(f"{label} duplicates PACKAGE_PREPARED")
            if index == 2 and event_type != "PACKAGE_ACTIVATED":
                errors.append(
                    "active Goal transition history lacks PACKAGE_ACTIVATED "
                    "immediately after preparation"
                )
            if not activated and event_type != "PACKAGE_ACTIVATED":
                errors.append(f"{label} occurs before PACKAGE_ACTIVATED")

            if event_type == "PACKAGE_ACTIVATED":
                if activated:
                    errors.append(f"{label} duplicates PACKAGE_ACTIVATED")
                if index != 2:
                    errors.append(
                        f"{label} PACKAGE_ACTIVATED is not immediately after preparation"
                    )
                if changes:
                    errors.append(
                        f"{label} PACKAGE_ACTIVATED must not change Goal status"
                    )
                focus_id = event.get("focus_goal_id")
                focus_status = statuses_before.get(str(focus_id))
                require_equal(
                    errors,
                    f"{label} activation from status",
                    event.get("from_status"),
                    focus_status,
                )
                require_equal(
                    errors,
                    f"{label} activation to status",
                    event.get("to_status"),
                    focus_status,
                )
                activated = True
                ...
                if not activated:
                    errors.append(f"{label} GOAL_STARTED precedes package activation")
                if (
                    not isinstance(subject_id, str)
                    or statuses_before.get(subject_id) != "READY"
                ):
                    errors.append(
                        f"{label} GOAL_STARTED subject is not replayed READY"
                    )
                require_equal(
                    errors,
                    f"{label} GOAL_STARTED status changes",
                    changes,
                    {subject_id: "IN_PROGRESS"},
                )
                require_equal(
                    errors,
                    f"{label} GOAL_STARTED from status",
                    event.get("from_status"),
                    "READY",
                )
                require_equal(
                    errors,
                    f"{label} GOAL_STARTED to status",
                    event.get("to_status"),
                    "IN_PROGRESS",
                )
                ...
                if changes:
                    errors.append(
                        f"{label} CANONICAL_BINDINGS_UPDATED must not change Goal status"
                    )
                focus_id = event.get("focus_goal_id")
                focus_status = statuses_before.get(str(focus_id))
                require_equal(
                    errors,
                    f"{label} canonical update from status",
                    event.get("from_status"),
                    focus_status,
                )
                require_equal(
                    errors,
                    f"{label} canonical update to status",
                    event.get("to_status"),
                    focus_status,
                )
                ...
                if (
                    not isinstance(subject_id, str)
                    or statuses_before.get(subject_id) != "IN_PROGRESS"
                ):
                    errors.append(
                        f"{label} GOAL_COMPLETED subject is not replayed IN_PROGRESS"
                    )
                require_equal(
                    errors,
                    f"{label} GOAL_COMPLETED status changes",
                    changes,
                    {subject_id: "COMPLETE_AT_TARGET"},
                )
                require_equal(
                    errors,
                    f"{label} GOAL_COMPLETED from status",
                    event.get("from_status"),
                    "IN_PROGRESS",
                )
                require_equal(
                    errors,
                    f"{label} GOAL_COMPLETED to status",
                    event.get("to_status"),
                    "COMPLETE_AT_TARGET",
                )
                ...
                if (
                    not isinstance(materialized_goal_id, str)
                    or materialized_goal_id in statuses_before
                ):
                    errors.append(
                        f"{label} GOAL_MATERIALIZED subject already exists"
                    )
                require_equal(
                    errors,
                    f"{label} GOAL_MATERIALIZED status changes",
                    changes,
                    {materialized_goal_id: "PLANNED"},
                )
                require_equal(
                    errors,
                    f"{label} GOAL_MATERIALIZED from status",
                    event.get("from_status"),
                    "",
                )
                require_equal(
                    errors,
                    f"{label} GOAL_MATERIALIZED to status",
                    event.get("to_status"),
                    "PLANNED",
                )
                ...
                if (
                    not isinstance(subject_id, str)
                    or statuses_before.get(subject_id) != "PLANNED"
                ):
                    errors.append(
                        f"{label} GOAL_READY subject is not replayed PLANNED"
                    )
                require_equal(
                    errors,
                    f"{label} GOAL_READY status changes",
                    changes,
                    {subject_id: "READY"},
                )
                require_equal(
                    errors,
                    f"{label} GOAL_READY from status",
                    event.get("from_status"),
                    "PLANNED",
                )
                require_equal(
                    errors,
                    f"{label} GOAL_READY to status",
                    event.get("to_status"),
                    "READY",
                )
        ...
        for goal_id, status in changes.items():
            if (
                ...
                and status in V23_RUNTIME_STATUSES
            ):
                if index > 1 and replay_statuses.get(goal_id) == status:
                    errors.append(f"{label} contains a no-op status change: {goal_id}")
        ...
        if lifecycle_pair not in V23_LIFECYCLE_STATUS_PAIRS:
            errors.append(f"{label} lifecycle status pair is invalid")
        elif lifecycle_pair != expected_pair:
            errors.append(f"{label} lifecycle status differs from replay")

        if index == 1:
            require_equal(
                errors,
                "active Goal prepared runtime focus ID",
                runtime.get("focus_goal_id"),
                EXPECTED_ACTIVE_GOAL_FOCUS_ID,
            )
            require_equal(
                errors,
                "active Goal prepared runtime focus path",
                runtime.get("focus_goal_path"),
                EXPECTED_ACTIVE_GOAL_FOCUS_PATH,
            )
            require_equal(
                errors,
                "active Goal prepared runtime ready frontier",
                runtime.get("ready_frontier_goal_ids"),
                list(EXPECTED_ACTIVE_GOAL_READY_FRONTIER),
            )
        else:
            require_equal(
                errors,
                f"{label} previous focus ID",
                event.get("previous_focus_goal_id"),
                previous_runtime.get("focus_goal_id"),
            )

        focus_id = runtime.get("focus_goal_id")
        require_equal(
            errors,
            f"{label} event/runtime focus ID",
            event.get("focus_goal_id"),
            focus_id,
        )
        if event_type == "GOAL_STARTED":
            require_equal(
                errors,
                f"{label} started/runtime focus ID",
                focus_id,
                event.get("subject_goal_id"),
            )

        ready_frontier = runtime.get("ready_frontier_goal_ids")
        if not isinstance(ready_frontier, list) or any(
            not isinstance(goal_id, str) for goal_id in ready_frontier
        ):
            errors.append(f"{label} runtime ready frontier must be a string list")
            ready_frontier = []
        for goal_id in ready_frontier:
            if replay_statuses.get(goal_id) not in {"READY", "IN_PROGRESS"}:
                errors.append(
                    f"{label} runtime ready frontier status differs: {goal_id}"
                )
        if ready_frontier and focus_id != ready_frontier[0]:
            errors.append(f"{label} runtime focus is not replay-deterministic")

        if focus_id not in {"", None}:
            if focus_id not in replay_statuses:
                errors.append(f"{label} runtime focus is absent from replayed status")
            expected_focus_path = goal_paths.get(str(focus_id))
            if expected_focus_path is None:
                errors.append(f"{label} runtime focus Goal path is unknown")
            else:
                require_equal(
                    errors,
                ...
                focus_file = resolve_safe_repo_file(root, expected_focus_path)
                if focus_file is None:
                    errors.append(f"{label} runtime focus Goal is missing or unsafe")
                else:
                    require_equal(
                        errors,
                        f"{label} focus Goal content SHA-256",
                        event.get("focus_goal_content_sha256"),
                        sha256_file(focus_file),
                    )
        elif lifecycle_pair != ("COMPLETED", "COMPLETED"):
            errors.append(f"{label} non-completed runtime has no focus Goal")

        previous_runtime = runtime
        event_hash = event.get("event_sha256")
        previous_hash = event_hash if isinstance(event_hash, str) else ""

    require_equal(
        errors,
        "active Goal replayed statuses",
        goal_execution.get("status_by_goal"),
        replay_statuses,
    )
    for field in V23_REPLAYED_RUNTIME_FIELDS:
        require_equal(
            errors,
            f"active Goal replayed runtime {field}",
            goal_execution.get(field),
            final_runtime.get(field),
        )
    require_equal(
        errors,
        "active Goal replayed master status (root)",
        goal_execution.get("goal_status"),
        replay_statuses.get(EXPECTED_ACTIVE_GOAL_MASTER_ID),
    )
    require_equal(
        errors,
        "active Goal transition history anchor",
        goal_execution.get("transition_history_anchor_sha256"),
        previous_hash,
    )


def live_event_binding(
    errors: list[str],
    *,
    label: str,
    root: Path,
    ...
    if resolved is None:
        errors.append(f"{label} is missing or unsafe: {path}")
        file_sha256 = ""
    else:
...
def validate_v23_fp006_legal_tail(
    errors: list[str],
    *,
    goal_execution: dict[str, Any],
    root: Path,
    ...
    if not isinstance(history, list):
        errors.append("active Goal FP006 transition history must be a list")
        return
    event_types = tuple(
        event.get("event_type") if isinstance(event, dict) else None
        for event in history
    )
    ready_tail = EXPECTED_V23_LEGAL_TAIL_EVENT_TYPES
    started_tail = ready_tail + ("GOAL_STARTED",)
    legal_tails = {ready_tail, started_tail}
    for suffix_length in range(
        1,
        len(EXPECTED_V23_FP010_TRANSITION_EVENT_TYPES) + 1,
    ):
        legal_tails.add(
            started_tail
            + EXPECTED_V23_FP010_TRANSITION_EVENT_TYPES[:suffix_length]
        )
    legal_tails.add(
        started_tail
        + EXPECTED_V23_FP010_TRANSITION_EVENT_TYPES
    ...
    for suffix_length in range(
        1,
        len(EXPECTED_V23_FP011_TRANSITION_EVENT_TYPES) + 1,
    ):
        legal_tails.add(
            fp010_started_tail
            + EXPECTED_V23_FP011_TRANSITION_EVENT_TYPES[:suffix_length]
        )
    if event_types not in legal_tails:
        errors.append(
            "active Goal transition tail must preserve seq1-8 and contain only "
            "the ordered FP006→FP010→FP011 completion/readiness suffix"
        )
        return

    prepared, activated, fp005_started, updated, completed, materialized, ready = (
        history[:7]
    )
    started = history[7] if len(history) == 8 else None
    if len(history) >= 8:
        started = history[7]
    successor_events = history[8:]
    expected_completion_binding = {
        "role": EXPECTED_FP005_COMPLETION_ROLE,
        "document_id": EXPECTED_FP005_COMPLETION_RECEIPT_ID,
        "path": EXPECTED_FP005_COMPLETION_RECEIPT_PATH,
        "file_sha256": EXPECTED_FP005_COMPLETION_RECEIPT_SHA256,
    }

    require_equal(
        errors,
        "active Goal activation event SHA-256",
        activated.get("event_sha256"),
        EXPECTED_V23_ACTIVATION_EVENT_SHA256,
    )
    require_equal(
        errors,
        "active Goal FP005 start subject",
        fp005_started.get("subject_goal_id"),
        EXPECTED_FP005_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP005 canonical producer",
        updated.get("produced_by_goal_id"),
        EXPECTED_FP005_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP005 changed binding roles",
        updated.get("changed_binding_roles"),
        [
            "IMPLEMENTATION_BACKLOG",
            "IMPLEMENTATION_GAP",
            EXPECTED_FP005_COMPLETION_ROLE,
    ...
    require_equal(
        errors,
        "active Goal FP005 changed subjects",
        updated.get("changed_subject_ids_by_role"),
        {
    ...
    require_equal(
        errors,
        "active Goal FP005 produced binding roles",
        updated.get("produced_binding_roles"),
        ["IMPLEMENTATION_BACKLOG", "IMPLEMENTATION_GAP"],
    )
    require_equal(
        errors,
        "active Goal FP005 completion receipt producer binding",
        updated.get("producer_completion_receipt_binding"),
        expected_completion_binding,
    )
    update_snapshot = updated.get("canonical_binding_snapshot_after")
    if not isinstance(update_snapshot, dict):
        errors.append(
            "active Goal FP005 canonical binding snapshot must be an object"
        )
    else:
        require_equal(
            errors,
            "active Goal FP005 update Gap binding",
            update_snapshot.get("IMPLEMENTATION_GAP"),
            {
                "role": "IMPLEMENTATION_GAP",
                "document_id": EXPECTED_R012_GAP_DOCUMENT_ID,
                "path": EXPECTED_R012_GAP_PATH,
                "file_sha256": EXPECTED_R012_GAP_FILE_SHA256,
            },
        )
        require_equal(
            errors,
            "active Goal FP005 update Backlog binding",
            update_snapshot.get("IMPLEMENTATION_BACKLOG"),
            {
                "role": "IMPLEMENTATION_BACKLOG",
                "document_id": EXPECTED_R012_BACKLOG_DOCUMENT_ID,
                "path": EXPECTED_R012_BACKLOG_PATH,
                "file_sha256": EXPECTED_R012_BACKLOG_FILE_SHA256,
            },
        )
        require_equal(
            errors,
            "active Goal FP005 update completion binding",
            update_snapshot.get(EXPECTED_FP005_COMPLETION_ROLE),
            expected_completion_binding,
        )

    require_equal(
        errors,
        "active Goal FP005 completion subject",
        completed.get("subject_goal_id"),
        EXPECTED_FP005_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP005 completion status changes",
        completed.get("status_changes"),
        {EXPECTED_FP005_GOAL_ID: "COMPLETE_AT_TARGET"},
    )
    require_equal(
        errors,
        "active Goal FP005 completion evidence refs",
        completed.get("evidence_refs"),
        [EXPECTED_FP005_COMPLETION_ROLE],
    )
    require_equal(
        errors,
        "active Goal FP005 completion evidence bindings",
        completed.get("completion_evidence_bindings"),
        {EXPECTED_FP005_COMPLETION_ROLE: expected_completion_binding},
    )
    require_equal(
        errors,
        "active Goal FP005 completion receipt binding",
        completed.get("completion_receipt_binding"),
        expected_completion_binding,
    )
    require_equal(
        errors,
        "active Goal FP005 completion canonical update",
        completed.get("canonical_update_event_sha256"),
        updated.get("event_sha256"),
    )

    require_equal(
        errors,
        "active Goal FP006 materialized goal ID",
        materialized.get("materialized_goal_id"),
        EXPECTED_CURRENT_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 materialized goal path",
        materialized.get("materialized_goal_path"),
        EXPECTED_CURRENT_GOAL_PATH,
    )
    require_equal(
        errors,
        "active Goal FP006 materialized status changes",
        materialized.get("status_changes"),
        {EXPECTED_CURRENT_GOAL_ID: "PLANNED"},
    )
    require_equal(
        errors,
        "active Goal FP006 materialized source role",
        materialized.get("materialized_from_role"),
        "IMPLEMENTATION_BACKLOG",
    )
    require_equal(
        errors,
        "active Goal FP006 materialized source path",
        materialized.get("materialized_from_path"),
        EXPECTED_R012_BACKLOG_PATH,
    )
    require_equal(
        errors,
        "active Goal FP006 materialized source document",
        materialized.get("materialized_from_document_id"),
        EXPECTED_R012_BACKLOG_DOCUMENT_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 materialized source SHA-256",
        materialized.get("materialized_from_sha256"),
        EXPECTED_R012_BACKLOG_FILE_SHA256,
    )
    require_equal(
        errors,
        "active Goal FP006 predecessor",
        materialized.get("predecessor_goal_id"),
        EXPECTED_FP005_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 predecessor SHA-256",
        materialized.get("predecessor_goal_content_sha256"),
        EXPECTED_FP005_GOAL_CONTENT_SHA256,
    )
    goal_file = resolve_safe_repo_file(root, EXPECTED_CURRENT_GOAL_PATH)
    if goal_file is None:
        errors.append("active Goal FP006 document is missing or unsafe")
    else:
        require_equal(
            errors,
            "active Goal FP006 materialized content SHA-256",
            materialized.get("materialized_goal_content_sha256"),
            sha256_file(goal_file),
        )

    require_equal(
        errors,
        "active Goal FP006 ready subject",
        ready.get("subject_goal_id"),
        EXPECTED_CURRENT_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 ready status changes",
        ready.get("status_changes"),
        {EXPECTED_CURRENT_GOAL_ID: "READY"},
    )
    require_equal(
        errors,
        "active Goal FP006 readiness lineage",
        ready.get("readiness_basis"),
        {
            "dependency_completion_events": [
                {
                    "goal_id": EXPECTED_FP005_GOAL_ID,
                    "event_sha256": completed.get("event_sha256"),
                }
            ]
        },
    )
    require_equal(errors, "active Goal FP006 start evidence refs", ready.get("evidence_refs"), [])
    require_equal(
        errors,
        "active Goal FP006 start evidence bindings",
        ready.get("start_evidence_bindings"),
        {},
    )
    require_equal(
        errors,
        "active Goal FP006 start evidence provenance",
        ready.get("start_evidence_provenance"),
        {},
    )
    for field in ("implementation_start_gate_binding", "repository_snapshot_before"):
        if field in ready:
            errors.append(f"active Goal FP006 READY event must not contain {field}")

    statuses = goal_execution.get("status_by_goal")
    if not isinstance(statuses, dict):
        statuses = {}
    require_equal(
        errors,
        "active Goal final FP005 status",
        statuses.get(EXPECTED_FP005_GOAL_ID),
        "COMPLETE_AT_TARGET",
    )
    require_equal(
        errors,
        "active Goal final FP006 status",
        statuses.get(EXPECTED_CURRENT_GOAL_ID),
        (
            "COMPLETE_AT_TARGET"
            if len(history) >= 10
            else "IN_PROGRESS"
    ...
    if len(history) <= 9:
        require_equal(
            errors,
            "active Goal final FP006 focus",
            goal_execution.get("focus_goal_id"),
            EXPECTED_CURRENT_GOAL_ID,
        )
        require_equal(
            errors,
            "active Goal final FP006 focus path",
            goal_execution.get("focus_goal_path"),
            EXPECTED_CURRENT_GOAL_PATH,
        )
        require_equal(
            errors,
            "active Goal final FP006 work item",
            goal_execution.get("focus_work_item_id"),
            EXPECTED_CURRENT_GOAL_WORK_ITEM_ID,
        )
        require_equal(
            errors,
            "active Goal final FP006 ready frontier",
            goal_execution.get("ready_frontier_goal_ids"),
            list(EXPECTED_CURRENT_GOAL_READY_FRONTIER),
        )
    elif 12 <= len(history) <= 14:
        require_equal(
            errors,
            "active Goal final FP010 focus",
            goal_execution.get("focus_goal_id"),
            EXPECTED_FP010_GOAL_ID,
        )
        require_equal(
            errors,
            "active Goal final FP010 focus path",
            goal_execution.get("focus_goal_path"),
            EXPECTED_FP010_GOAL_PATH,
        )
        require_equal(
            errors,
            "active Goal final FP010 work item",
            goal_execution.get("focus_work_item_id"),
            EXPECTED_FP010_GOAL_WORK_ITEM_ID,
        )
        require_equal(
            errors,
            "active Goal final FP010 ready frontier",
            goal_execution.get("ready_frontier_goal_ids"),
            list(EXPECTED_FP010_GOAL_READY_FRONTIER),
        )
    elif len(history) == 17:
        require_equal(
            errors,
            "active Goal final FP011 focus",
            goal_execution.get("focus_goal_id"),
            EXPECTED_FP011_GOAL_ID,
        )
        require_equal(
            errors,
            "active Goal final FP011 focus path",
            goal_execution.get("focus_goal_path"),
            EXPECTED_FP011_GOAL_PATH,
        )
        require_equal(
            errors,
            "active Goal final FP011 work item",
            goal_execution.get("focus_work_item_id"),
            EXPECTED_FP011_GOAL_WORK_ITEM_ID,
        )
        require_equal(
            errors,
            "active Goal final FP011 ready frontier",
            goal_execution.get("ready_frontier_goal_ids"),
            list(EXPECTED_FP011_GOAL_READY_FRONTIER),
        )
    require_equal(
        errors,
        "active Goal master/root summary status",
        goal_execution.get("goal_status"),
        statuses.get(EXPECTED_ACTIVE_GOAL_MASTER_ID),
    )
    require_equal(
        errors,
        "active Goal pending producer completion",
        goal_execution.get("pending_producer_completion_goal_id"),
        "",
    )
    require_equal(
        errors,
        "active Goal pending reopen goals",
        goal_execution.get("pending_reopen_goal_ids"),
        [],
    )

    completion_evidence = goal_execution.get("completion_evidence_by_goal")
    if not isinstance(completion_evidence, dict):
        completion_evidence = {}
    require_equal(
        errors,
        "active Goal FP005 completion evidence inventory",
        completion_evidence.get(EXPECTED_FP005_GOAL_ID),
        [EXPECTED_FP005_COMPLETION_ROLE],
    )
    dynamic_inventory = goal_execution.get("dynamic_goal_inventory")
    if not isinstance(dynamic_inventory, dict):
        dynamic_inventory = {}
    fp006_inventory = dynamic_inventory.get(EXPECTED_CURRENT_GOAL_ID)
    if not isinstance(fp006_inventory, dict):
        errors.append("active Goal FP006 dynamic inventory record is missing")
    else:
        for label, key, expected in (
            ("goal ID", "goal_id", EXPECTED_CURRENT_GOAL_ID),
            ("path", "path", EXPECTED_CURRENT_GOAL_PATH),
            ("goal kind", "goal_kind", "WORK_ITEM"),
            ("work item type", "work_item_type", "POLICY_GAP_WORK"),
            ("parent goal", "parent_goal_id", "WS-GOAL-EPIC-02"),
            (
                "materialized event",
                "materialized_event_sha256",
                materialized.get("event_sha256"),
            ),
            ("source role", "materialized_from_role", "IMPLEMENTATION_BACKLOG"),
            ("source path", "materialized_from_path", EXPECTED_R012_BACKLOG_PATH),
            (
                "source document",
            ...
            ("predecessor", "predecessor_goal_id", EXPECTED_FP005_GOAL_ID),
            (
                "predecessor SHA-256",
            ...
            require_equal(
                errors,
                f"active Goal FP006 inventory {label}",
                fp006_inventory.get(key),
                expected,
            )
        if goal_file is not None:
            require_equal(
                errors,
                "active Goal FP006 inventory content SHA-256",
                fp006_inventory.get("sha256"),
                sha256_file(goal_file),
            )
    materialized_children = goal_execution.get(
        "materialized_child_goal_ids_by_parent"
    )
    if not isinstance(materialized_children, dict):
        materialized_children = {}
    epic02_children = materialized_children.get("WS-GOAL-EPIC-02")
    if not isinstance(epic02_children, list):
        errors.append("active Goal EPIC02 materialized children must be a list")
    else:
        expected_latest_child = (
            EXPECTED_FP011_GOAL_ID
            if len(history) >= 16
            else EXPECTED_FP010_GOAL_ID
            if len(history) >= 11
            else EXPECTED_CURRENT_GOAL_ID
        )
        if not epic02_children or epic02_children[-1] != expected_latest_child:
            errors.append(
                f"active Goal {expected_latest_child} must be the latest "
                "EPIC02 materialized child"
            )
    ...
    require_equal(
        errors,
        "active Goal FP006 started subject",
        started.get("subject_goal_id"),
        EXPECTED_CURRENT_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 started status changes",
        started.get("status_changes"),
        {EXPECTED_CURRENT_GOAL_ID: "IN_PROGRESS"},
    )
    validate_fp006_start_gate_binding(errors, event=started, root=root)
    if successor_events:
        validate_v23_fp010_suffix(
            errors,
            goal_execution=goal_execution,
            events=successor_events,
            root=root,
            fp006_inventory=fp006_inventory,
        )


def validate_v23_fp010_suffix(
    errors: list[str],
    *,
    goal_execution: dict[str, Any],
    events: list[Any],
    ...
    if not isinstance(updated, dict):
        errors.append("active Goal FP006 canonical update event must be an object")
        return
    gap_binding = live_event_binding(
        errors,
        label="active Goal r013 Gap",
        root=root,
        role="IMPLEMENTATION_GAP",
        document_id=EXPECTED_R013_GAP_DOCUMENT_ID,
        path=EXPECTED_R013_GAP_PATH,
    )
    backlog_binding = live_event_binding(
        errors,
        label="active Goal r013 Backlog",
        root=root,
        role="IMPLEMENTATION_BACKLOG",
        document_id=EXPECTED_R013_BACKLOG_DOCUMENT_ID,
        path=EXPECTED_R013_BACKLOG_PATH,
    )
    completion_binding = live_event_binding(
        errors,
        label="active Goal FP006 completion receipt",
        root=root,
        role=EXPECTED_FP006_COMPLETION_ROLE,
        document_id=EXPECTED_FP006_COMPLETION_RECEIPT_ID,
        path=EXPECTED_FP006_COMPLETION_RECEIPT_PATH,
    )
    require_equal(
        errors,
        "active Goal FP006 canonical producer",
        updated.get("produced_by_goal_id"),
        EXPECTED_CURRENT_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 changed binding roles",
        updated.get("changed_binding_roles"),
        [
            "IMPLEMENTATION_BACKLOG",
            "IMPLEMENTATION_GAP",
    ...
    require_equal(
        errors,
        "active Goal FP006 changed subjects",
        updated.get("changed_subject_ids_by_role"),
        {
    ...
    require_equal(
        errors,
        "active Goal FP006 produced binding roles",
        updated.get("produced_binding_roles"),
        ["IMPLEMENTATION_BACKLOG", "IMPLEMENTATION_GAP"],
    )
    require_equal(
        errors,
        "active Goal FP006 completion receipt producer binding",
        updated.get("producer_completion_receipt_binding"),
        completion_binding,
    )
    update_snapshot = updated.get("canonical_binding_snapshot_after")
    if not isinstance(update_snapshot, dict):
        errors.append(
            "active Goal FP006 canonical binding snapshot must be an object"
        )
    else:
        for label, role, expected in (
            ("Gap", "IMPLEMENTATION_GAP", gap_binding),
            ("Backlog", "IMPLEMENTATION_BACKLOG", backlog_binding),
            ("completion", EXPECTED_FP006_COMPLETION_ROLE, completion_binding),
        ):
            require_equal(
                errors,
                f"active Goal FP006 update {label} binding",
    ...
    if not isinstance(completed, dict):
        errors.append("active Goal FP006 completion event must be an object")
        return
    require_equal(
        errors,
        "active Goal FP006 completion subject",
        completed.get("subject_goal_id"),
        EXPECTED_CURRENT_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP006 completion status changes",
        completed.get("status_changes"),
        {EXPECTED_CURRENT_GOAL_ID: "COMPLETE_AT_TARGET"},
    )
    require_equal(
        errors,
        "active Goal FP006 completion evidence refs",
        completed.get("evidence_refs"),
        [EXPECTED_FP006_COMPLETION_ROLE],
    )
    require_equal(
        errors,
        "active Goal FP006 completion evidence bindings",
        completed.get("completion_evidence_bindings"),
        {EXPECTED_FP006_COMPLETION_ROLE: completion_binding},
    )
    require_equal(
        errors,
        "active Goal FP006 completion receipt binding",
        completed.get("completion_receipt_binding"),
        completion_binding,
    )
    require_equal(
        errors,
        "active Goal FP006 completion canonical update",
        completed.get("canonical_update_event_sha256"),
        updated.get("event_sha256"),
    )
    completion_evidence = goal_execution.get("completion_evidence_by_goal")
    ...
    require_equal(
        errors,
        "active Goal FP006 completion evidence inventory",
        completion_evidence.get(EXPECTED_CURRENT_GOAL_ID),
        [EXPECTED_FP006_COMPLETION_ROLE],
    )

    if len(events) == 2:
        return
    materialized = events[2]
    if not isinstance(materialized, dict):
        errors.append("active Goal FP010 materialized event must be an object")
        return
    fp006_goal = resolve_safe_repo_file(root, EXPECTED_CURRENT_GOAL_PATH)
    fp010_goal = resolve_safe_repo_file(root, EXPECTED_FP010_GOAL_PATH)
    if fp006_goal is None:
        errors.append("active Goal FP006 document is missing or unsafe")
        fp006_goal_sha256 = ""
    else:
        fp006_goal_sha256 = sha256_file(fp006_goal)
    if fp010_goal is None:
        errors.append("active Goal FP010 document is missing or unsafe")
        fp010_goal_sha256 = ""
    else:
        fp010_goal_sha256 = sha256_file(fp010_goal)
    require_equal(
        errors,
        "active Goal FP010 materialized goal ID",
        materialized.get("materialized_goal_id"),
        EXPECTED_FP010_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP010 materialized goal path",
        materialized.get("materialized_goal_path"),
        EXPECTED_FP010_GOAL_PATH,
    )
    require_equal(
        errors,
        "active Goal FP010 materialized status changes",
        materialized.get("status_changes"),
        {EXPECTED_FP010_GOAL_ID: "PLANNED"},
    )
    for label, actual, expected in (
        ("source role", materialized.get("materialized_from_role"), "IMPLEMENTATION_BACKLOG"),
        ("source path", materialized.get("materialized_from_path"), EXPECTED_R013_BACKLOG_PATH),
        (
            "source document",
            materialized.get("materialized_from_document_id"),
            EXPECTED_R013_BACKLOG_DOCUMENT_ID,
        ...
        (
            "source SHA-256",
            materialized.get("materialized_from_sha256"),
            backlog_binding["file_sha256"],
        ),
        ("predecessor", materialized.get("predecessor_goal_id"), EXPECTED_CURRENT_GOAL_ID),
        (
            "predecessor SHA-256",
            materialized.get("predecessor_goal_content_sha256"),
            fp006_goal_sha256,
        ...
        require_equal(errors, f"active Goal FP010 materialized {label}", actual, expected)

    dynamic_inventory = goal_execution.get("dynamic_goal_inventory")
    if not isinstance(dynamic_inventory, dict):
        dynamic_inventory = {}
    fp010_inventory = dynamic_inventory.get(EXPECTED_FP010_GOAL_ID)
    if not isinstance(fp010_inventory, dict):
        errors.append("active Goal FP010 dynamic inventory record is missing")
    else:
        for label, key, expected in (
            ("goal ID", "goal_id", EXPECTED_FP010_GOAL_ID),
            ("path", "path", EXPECTED_FP010_GOAL_PATH),
            ("content SHA-256", "sha256", fp010_goal_sha256),
            ("goal kind", "goal_kind", "WORK_ITEM"),
            ("work item type", "work_item_type", "POLICY_GAP_WORK"),
            ("parent goal", "parent_goal_id", "WS-GOAL-EPIC-02"),
            (
            ...
            ("source role", "materialized_from_role", "IMPLEMENTATION_BACKLOG"),
            ("source path", "materialized_from_path", EXPECTED_R013_BACKLOG_PATH),
            (
                "source document",
                "materialized_from_document_id",
                EXPECTED_R013_BACKLOG_DOCUMENT_ID,
            ...
            ("predecessor", "predecessor_goal_id", EXPECTED_CURRENT_GOAL_ID),
            (
                "predecessor SHA-256",
                "predecessor_goal_content_sha256",
                fp006_goal_sha256,
            ...
            require_equal(
                errors,
                f"active Goal FP010 inventory {label}",
                fp010_inventory.get(key),
                expected,
            )
    ...
    if not isinstance(ready, dict):
        errors.append("active Goal FP010 ready event must be an object")
        return
    require_equal(
        errors,
        "active Goal FP010 ready subject",
        ready.get("subject_goal_id"),
        EXPECTED_FP010_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP010 ready status changes",
        ready.get("status_changes"),
        {EXPECTED_FP010_GOAL_ID: "READY"},
    )
    require_equal(
        errors,
        "active Goal FP010 readiness lineage",
        ready.get("readiness_basis"),
        {
            "dependency_completion_events": [
                {
                    "goal_id": EXPECTED_CURRENT_GOAL_ID,
                    "event_sha256": completed.get("event_sha256"),
                }
            ]
        },
    ...
    require_equal(
        errors,
        "active Goal FP010 start evidence refs",
        ready.get("evidence_refs"),
        [],
    )
    require_equal(
        errors,
        "active Goal FP010 start evidence bindings",
        ready.get("start_evidence_bindings"),
        {},
    )
    require_equal(
        errors,
        "active Goal FP010 start evidence provenance",
        ready.get("start_evidence_provenance"),
        {},
    )
    for field in ("implementation_start_gate_binding", "repository_snapshot_before"):
        if field in ready:
            errors.append(f"active Goal FP010 READY event must not contain {field}")
    statuses = goal_execution.get("status_by_goal")
    if not isinstance(statuses, dict):
        statuses = {}
    require_equal(
        errors,
        "active Goal final FP010 status",
        statuses.get(EXPECTED_FP010_GOAL_ID),
        (
            "COMPLETE_AT_TARGET"
            if len(events) >= 7
            else "IN_PROGRESS"
    ...
    if not isinstance(started, dict):
        errors.append("active Goal FP010 start event must be an object")
        return
    require_equal(
        errors,
        "active Goal FP010 started subject",
        started.get("subject_goal_id"),
        EXPECTED_FP010_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP010 started status changes",
        started.get("status_changes"),
        {EXPECTED_FP010_GOAL_ID: "IN_PROGRESS"},
    )
    validate_start_gate_binding(
        errors,
        event=started,
        root=root,
        goal_id=EXPECTED_FP010_GOAL_ID,
        goal_path=EXPECTED_FP010_GOAL_PATH,
        goal_label="FP010",
        expected_controlled_paths=EXPECTED_SEQ13_CONTROLLED_PATHS,
    )
    if len(events) > 5:
        validate_v23_fp011_suffix(
            errors,
            goal_execution=goal_execution,
            events=events[5:],
            root=root,
...
def validate_v23_fp011_suffix(
    ...
    *,
    ...
    updated = events[0]
    if not isinstance(updated, dict):
        errors.append("active Goal FP010 canonical update event must be an object")
        return
    gap_binding = live_event_binding(
        errors,
        label="active Goal r014 Gap",
        root=root,
        role="IMPLEMENTATION_GAP",
        document_id=EXPECTED_R014_GAP_DOCUMENT_ID,
        path=EXPECTED_R014_GAP_PATH,
    )
    backlog_binding = live_event_binding(
        errors,
        label="active Goal r014 Backlog",
        root=root,
        role="IMPLEMENTATION_BACKLOG",
        document_id=EXPECTED_R014_BACKLOG_DOCUMENT_ID,
        path=EXPECTED_R014_BACKLOG_PATH,
    )
    completion_binding = live_event_binding(
        errors,
        label="active Goal FP010 completion receipt",
        root=root,
        role=EXPECTED_FP010_COMPLETION_ROLE,
        document_id=EXPECTED_FP010_COMPLETION_RECEIPT_ID,
        path=EXPECTED_FP010_COMPLETION_RECEIPT_PATH,
    )
    require_equal(
        errors,
        "active Goal FP010 canonical producer",
        updated.get("produced_by_goal_id"),
        EXPECTED_FP010_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP010 changed binding roles",
        updated.get("changed_binding_roles"),
        [
            "IMPLEMENTATION_BACKLOG",
            "IMPLEMENTATION_GAP",
    ...
    require_equal(
        errors,
        "active Goal FP010 changed subjects",
        updated.get("changed_subject_ids_by_role"),
        {
    ...
    require_equal(
        errors,
        "active Goal FP010 produced binding roles",
        updated.get("produced_binding_roles"),
        ["IMPLEMENTATION_BACKLOG", "IMPLEMENTATION_GAP"],
    )
    require_equal(
        errors,
        "active Goal FP010 completion receipt producer binding",
        updated.get("producer_completion_receipt_binding"),
        completion_binding,
    )
    update_snapshot = updated.get("canonical_binding_snapshot_after")
    if not isinstance(update_snapshot, dict):
        errors.append(
            "active Goal FP010 canonical binding snapshot must be an object"
        )
    else:
        for label, role, expected in (
            ("Gap", "IMPLEMENTATION_GAP", gap_binding),
            ("Backlog", "IMPLEMENTATION_BACKLOG", backlog_binding),
            ("completion", EXPECTED_FP010_COMPLETION_ROLE, completion_binding),
        ):
            require_equal(
                errors,
                f"active Goal FP010 update {label} binding",
                update_snapshot.get(role),
                expected,
            )
    ...
    completed = events[1]
    if not isinstance(completed, dict):
        errors.append("active Goal FP010 completion event must be an object")
        return
    require_equal(
        errors,
        "active Goal FP010 completion subject",
        completed.get("subject_goal_id"),
        EXPECTED_FP010_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP010 completion status changes",
        completed.get("status_changes"),
        {EXPECTED_FP010_GOAL_ID: "COMPLETE_AT_TARGET"},
    )
    require_equal(
        errors,
        "active Goal FP010 completion evidence refs",
        completed.get("evidence_refs"),
        [EXPECTED_FP010_COMPLETION_ROLE],
    )
    require_equal(
        errors,
        "active Goal FP010 completion evidence bindings",
        completed.get("completion_evidence_bindings"),
        {EXPECTED_FP010_COMPLETION_ROLE: completion_binding},
    )
    require_equal(
        errors,
        "active Goal FP010 completion receipt binding",
        completed.get("completion_receipt_binding"),
        completion_binding,
    )
    require_equal(
        errors,
        "active Goal FP010 completion canonical update",
        completed.get("canonical_update_event_sha256"),
        updated.get("event_sha256"),
    )
    completion_evidence = goal_execution.get("completion_evidence_by_goal")
    ...
    require_equal(
        errors,
        "active Goal FP010 completion evidence inventory",
        completion_evidence.get(EXPECTED_FP010_GOAL_ID),
        [EXPECTED_FP010_COMPLETION_ROLE],
    )
    ...
    materialized = events[2]
    if not isinstance(materialized, dict):
        errors.append("active Goal FP011 materialized event must be an object")
        return
    fp010_goal = resolve_safe_repo_file(root, EXPECTED_FP010_GOAL_PATH)
    fp011_goal = resolve_safe_repo_file(root, EXPECTED_FP011_GOAL_PATH)
    if fp010_goal is None:
        errors.append("active Goal FP010 document is missing or unsafe")
        fp010_goal_sha256 = ""
    else:
        fp010_goal_sha256 = sha256_file(fp010_goal)
    if fp011_goal is None:
        errors.append("active Goal FP011 document is missing or unsafe")
        fp011_goal_sha256 = ""
    else:
        fp011_goal_sha256 = sha256_file(fp011_goal)
    require_equal(
        errors,
        "active Goal FP011 materialized goal ID",
        materialized.get("materialized_goal_id"),
        EXPECTED_FP011_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP011 materialized goal path",
        materialized.get("materialized_goal_path"),
        EXPECTED_FP011_GOAL_PATH,
    )
    require_equal(
        errors,
        "active Goal FP011 materialized status changes",
        materialized.get("status_changes"),
        {EXPECTED_FP011_GOAL_ID: "PLANNED"},
    )
    for label, actual, expected in (
        (
            "source role",
        ...
        require_equal(
            errors,
            f"active Goal FP011 materialized {label}",
            actual,
            expected,
        )
    ...
    if not isinstance(dynamic_inventory, dict):
        dynamic_inventory = {}
    fp011_inventory = dynamic_inventory.get(EXPECTED_FP011_GOAL_ID)
    if not isinstance(fp011_inventory, dict):
        errors.append("active Goal FP011 dynamic inventory record is missing")
    else:
        for label, key, expected in (
            ("goal ID", "goal_id", EXPECTED_FP011_GOAL_ID),
            ("path", "path", EXPECTED_FP011_GOAL_PATH),
            ("content SHA-256", "sha256", fp011_goal_sha256),
            ("goal kind", "goal_kind", "WORK_ITEM"),
            ("work item type", "work_item_type", "POLICY_GAP_WORK"),
            ("parent goal", "parent_goal_id", "WS-GOAL-EPIC-02"),
            (
            ...
            ("source role", "materialized_from_role", "IMPLEMENTATION_BACKLOG"),
            ("source path", "materialized_from_path", EXPECTED_R014_BACKLOG_PATH),
            (
                "source document",
                "materialized_from_document_id",
                EXPECTED_R014_BACKLOG_DOCUMENT_ID,
            ...
            ("predecessor", "predecessor_goal_id", EXPECTED_FP010_GOAL_ID),
            (
                "predecessor SHA-256",
                "predecessor_goal_content_sha256",
                fp010_goal_sha256,
            ...
            require_equal(
                errors,
                f"active Goal FP011 inventory {label}",
                fp011_inventory.get(key),
                expected,
            )
    ...
    require_equal(
        errors,
        "active Goal final FP011 status",
        statuses.get(EXPECTED_FP011_GOAL_ID),
        "READY" if len(events) == 4 else "PLANNED",
    )
    if len(events) == 3:
        return
    ready = events[3]
    if not isinstance(ready, dict):
        errors.append("active Goal FP011 ready event must be an object")
        return
    require_equal(
        errors,
        "active Goal FP011 ready subject",
        ready.get("subject_goal_id"),
        EXPECTED_FP011_GOAL_ID,
    )
    require_equal(
        errors,
        "active Goal FP011 ready status changes",
        ready.get("status_changes"),
        {EXPECTED_FP011_GOAL_ID: "READY"},
    )
    require_equal(
        errors,
        "active Goal FP011 readiness lineage",
        ready.get("readiness_basis"),
        {
            "dependency_completion_events": [
                {
    ...
    require_equal(
        errors,
        "active Goal FP011 start evidence refs",
        ready.get("evidence_refs"),
        [],
    )
    require_equal(
        errors,
        "active Goal FP011 start evidence bindings",
        ready.get("start_evidence_bindings"),
        {},
    )
    require_equal(
        errors,
        "active Goal FP011 start evidence provenance",
        ready.get("start_evidence_provenance"),
        {},
    )
    for field in (
        ...
        if field in ready:
            errors.append(f"active Goal FP011 READY event must not contain {field}")


def validate_fp006_start_gate_binding(
    errors: list[str],
    *,
    event: dict[str, Any],
    root: Path,
    ...
    validate_start_gate_binding(
        ...
        root=root,
        goal_id=EXPECTED_CURRENT_GOAL_ID,
        goal_path=EXPECTED_CURRENT_GOAL_PATH,
        goal_label="FP006",
        expected_controlled_paths=EXPECTED_SEQ8_CONTROLLED_PATHS,
    )


def validate_start_gate_binding(
    errors: list[str],
    *,
    event: dict[str, Any],
    root: Path,
    ...
    goal_path: str,
    goal_label: str,
    expected_controlled_paths: tuple[str, ...],
) -> None:
    event_id = event.get("event_id")
    binding = event.get("implementation_start_gate_binding")
    repository_snapshot = event.get("repository_snapshot_before")
    if not isinstance(event_id, str) or not event_id:
        errors.append(f"active Goal {goal_label} start event ID is missing")
        return
    if not isinstance(binding, dict):
        errors.append(
            f"active Goal {goal_label} start gate binding must be an object"
        )
        return
    expected_path = (
    ...
    require_equal(
        errors,
        f"active Goal {goal_label} start gate binding fields",
        set(binding),
        {"document_id", "path", "file_sha256"},
    )
    require_equal(
        errors,
        f"active Goal {goal_label} start gate event-scoped path",
        binding.get("path"),
        expected_path,
    )
    ...
    if receipt_path is None:
        errors.append(
            f"active Goal {goal_label} start gate receipt is missing or unsafe"
        )
        return
    require_equal(
        errors,
        f"active Goal {goal_label} start gate receipt SHA-256",
    ...
    try:
        ...
        errors.append(
            f"active Goal {goal_label} start gate receipt cannot be loaded: {exc}"
        )
        return
    for label, actual, expected in (
        ("document ID", receipt.get("document_id"), binding.get("document_id")),
        ("schema version", receipt.get("schema_version"), "1.0"),
        (
            "evidence type",
            receipt.get("evidence_type"),
            "IMPLEMENTATION_START_OR_RESUME_GATE",
        ),
        ("purpose", receipt.get("gate_purpose"), "INITIAL_START"),
        ("status", receipt.get("status"), "PASS"),
        ("package ID", receipt.get("package_id"), EXPECTED_ACTIVE_GOAL_PACKAGE_ID),
        ("target event", receipt.get("target_transition_event_id"), event_id),
        ("target goal", receipt.get("target_goal_id"), goal_id),
        (
            "manifest SHA-256",
        ...
        (
            ...
            EXPECTED_V23_START_GATE_CONTRACT_VERSION,
        ),
        (
            "check contract SHA-256",
        ...
        require_equal(
            errors,
            f"active Goal {goal_label} start gate {label}",
            actual,
            expected,
        )
    ...
    if goal_file is not None:
        require_equal(
            errors,
            f"active Goal {goal_label} start gate target content SHA-256",
            receipt.get("target_goal_content_sha256"),
            sha256_file(goal_file),
        )
    if not isinstance(repository_snapshot, dict):
        errors.append(
            f"active Goal {goal_label} start repository snapshot must be an object"
        )
    else:
        require_equal(
            errors,
            f"active Goal {goal_label} receipt/event repository snapshot binding",
            receipt.get("repository_snapshot"),
            repository_snapshot,
        )
        require_equal(
            errors,
            f"active Goal {goal_label} repository snapshot event ID",
            repository_snapshot.get("gate_event_id"),
            event_id,
        )
        require_equal(
            errors,
            f"active Goal {goal_label} repository snapshot controlled path count",
            repository_snapshot.get("checkpoint_managed_path_count"),
            len(expected_controlled_paths),
        )
        require_equal(
            errors,
            f"active Goal {goal_label} repository snapshot controlled path SHA-256",
            repository_snapshot.get("checkpoint_path_set_sha256"),
            path_set_sha256(expected_controlled_paths),
        )
    check_runs = receipt.get("check_runs")
    if not isinstance(check_runs, list) or len(check_runs) != 19:
        errors.append(
            f"active Goal {goal_label} start gate must contain exactly 19 checks"
        )
        return
    repository_run = check_runs[-1]
    if not isinstance(repository_run, dict):
        errors.append(
            f"active Goal {goal_label} repository-state check must be an object"
        )
        return
    require_equal(
        errors,
        f"active Goal {goal_label} final gate check ID",
        repository_run.get("check_id"),
        "REPOSITORY_STATE",
    )
    expected_output_path = (
        f"docs/control/execution/goal-gates/{event_id}/19-REPOSITORY_STATE.log"
    )
    require_equal(
        errors,
        f"active Goal {goal_label} repository-state output path",
        repository_run.get("output_path"),
        expected_output_path,
    )
    output_path = resolve_safe_repo_file(root, repository_run.get("output_path"))
    if output_path is None:
        errors.append(
            f"active Goal {goal_label} repository-state output is missing or unsafe"
        )
        return
    output_sha256 = sha256_file(output_path)
    require_equal(
        errors,
        f"active Goal {goal_label} repository-state output SHA-256",
    ...
    if isinstance(repository_snapshot, dict):
        require_equal(
            errors,
            f"active Goal {goal_label} repository snapshot output SHA-256",
            repository_snapshot.get("gate_repository_state_output_sha256"),
            output_sha256,
        )
    try:
        ...
        errors.append(
            f"active Goal {goal_label} repository-state output cannot be loaded: {exc}"
        )
        return
    require_equal(
        errors,
        f"active Goal {goal_label} repository-state evidence type",
        repository_payload.get("evidence_type"),
        GATE_REPOSITORY_STATE_EVIDENCE_TYPE,
    )
    require_equal(
        errors,
        f"active Goal {goal_label} repository-state event ID",
        repository_payload.get("gate_event_id"),
        event_id,
    )
    controlled_snapshot = repository_payload.get(
        "checkpoint_controlled_working_snapshot"
    )
    if not isinstance(controlled_snapshot, dict):
        errors.append(
            f"active Goal {goal_label} repository-state controlled snapshot is missing"
        )
    elif isinstance(repository_snapshot, dict):
        require_equal(
            errors,
            f"active Goal {goal_label} repository-state controlled path count",
            controlled_snapshot.get("managed_changed_path_count"),
            repository_snapshot.get("checkpoint_managed_path_count"),
        )
        require_equal(
            errors,
            f"active Goal {goal_label} repository-state controlled path SHA-256",
            controlled_snapshot.get("path_set_sha256"),
            repository_snapshot.get("checkpoint_path_set_sha256"),
        )
        require_equal(
            errors,
            f"active Goal {goal_label} repository-state controlled content SHA-256",
            controlled_snapshot.get("content_set_sha256"),
            repository_snapshot.get("checkpoint_content_set_sha256"),
        )
...
def validate_goal_package_binding(
    ...
    statuses = goal_execution.get("status_by_goal")
    if not isinstance(statuses, dict):
        errors.append("active Goal status_by_goal must be an object")
    ...
    require_equal(
        errors,
        "active Goal manifest schema version",
    ...
    validate_v23_transition_replay(
        errors,
        goal_execution,
        root,
        active_manifest_hash,
    )
    validate_v23_fp006_legal_tail(
        errors,
        goal_execution=goal_execution,
        root=root,
    )
    validate_v23_mixed_owned_goal_package(
        errors,
        root=root,
        manifest=active_manifest,
        goal_execution=goal_execution,
    )
    validate_v22_archived_checkpoint(errors, root)

    v22_manifest, _ = load_goal_manifest(
        errors,
        label="superseded v2.2",
        root=root,
        manifest_path=EXPECTED_V22_GOAL_MANIFEST_PATH,
        expected_sha256=EXPECTED_V22_GOAL_MANIFEST_SHA256,
    )
    require_equal(
        errors,
        "superseded v2.2 Goal package ID",
        v22_manifest.get("package_id"),
        EXPECTED_V22_GOAL_PACKAGE_ID,
    )
    require_equal(
        errors,
        "superseded v2.2 Goal plan version",
        v22_manifest.get("plan_version"),
        EXPECTED_V22_GOAL_PLAN_VERSION,
    )
    validate_protected_goal_package(
        ...
        label="superseded v2.2",
        root=root,
        manifest=v22_manifest,
        manifest_path=EXPECTED_V22_GOAL_MANIFEST_PATH,
        expected_package_paths=EXPECTED_FROZEN_V22_GOAL_PACKAGE_PATHS,
        expected_protected_file_count=19,
        expected_path_set_sha256=EXPECTED_V22_PACKAGE_PATH_SET_SHA256,
        expected_content_set_sha256=EXPECTED_V22_PACKAGE_CONTENT_SET_SHA256,
    ...
    if not isinstance(active_supersedes, dict):
        ...
        active_supersedes = {}
    for label, key, expected in (
        ("package ID", "package_id", EXPECTED_V22_GOAL_PACKAGE_ID),
        ("plan version", "plan_version", EXPECTED_V22_GOAL_PLAN_VERSION),
        ("activation status", "activation_status", "ACTIVE"),
        ("manifest path", "manifest_path", EXPECTED_V22_GOAL_MANIFEST_PATH),
        (
            "manifest SHA-256",
            "manifest_sha256",
            EXPECTED_V22_GOAL_MANIFEST_SHA256,
        ...
        (
            "archived checkpoint path",
            "archived_checkpoint_path",
            EXPECTED_V22_ARCHIVED_CHECKPOINT_PATH,
        ),
        (
            "archived checkpoint SHA-256",
        ...
        (
            "transition history anchor",
            "transition_history_anchor_sha256",
            EXPECTED_V22_TRANSITION_HISTORY_ANCHOR_SHA256,
        ),
        (
            "supersession record path",
        ...
        require_equal(
            errors,
            f"active Goal manifest superseded v2.2 {label}",
...
def validate(checkpoint_path: Path = DEFAULT_CHECKPOINT, root: Path = ROOT) -> list[str]:
    ...
    history = goal_execution.get("transition_history")
    transition_event_count = len(history) if isinstance(history, list) else 0
    fp010_successor_active = transition_event_count >= 9
    fp011_successor_active = transition_event_count >= 14
    ...
    if fp010_successor_active:
        required_roles.add(EXPECTED_FP006_COMPLETION_ROLE)
    if fp011_successor_active:
        required_roles.add(EXPECTED_FP010_COMPLETION_ROLE)
    missing_roles = sorted(required_roles - bindings.keys())
    if missing_roles:
        errors.append(f"canonical bindings missing roles: {missing_roles}")

    expected_successor_canonical_bindings = dict(
        EXPECTED_SUCCESSOR_CANONICAL_BINDINGS
    )
    if fp010_successor_active:
        expected_successor_canonical_bindings.update(
            {
                "IMPLEMENTATION_GAP": {
                    "path": EXPECTED_R013_GAP_PATH,
                    "document_id": EXPECTED_R013_GAP_DOCUMENT_ID,
    ...
    if fp010_successor_active and isinstance(history, list):
        canonical_update = history[13] if fp011_successor_active else history[8]
        event_snapshot = (
            canonical_update.get("canonical_binding_snapshot_after")
            if isinstance(canonical_update, dict)
            else None
        )
        if not isinstance(event_snapshot, dict):
            errors.append(
                ...
                + " canonical update event snapshot must be an object"
            )
        else:
            completion_role = (
                EXPECTED_FP010_COMPLETION_ROLE
                if fp011_successor_active
                else EXPECTED_FP006_COMPLETION_ROLE
            )
            for role in (
                "IMPLEMENTATION_GAP",
                "IMPLEMENTATION_BACKLOG",
                ...
                require_equal(
                    errors,
                    f"{role} top-level/event snapshot binding",
                    {
    ...
    try:
        ...
        gap_r011_path = resolve_safe_repo_file(
            root,
            "docs/control/audits/"
            "walksafe-implementation-gap-analysis-20260724-r011.json",
        )
        gap_r012_path = resolve_safe_repo_file(root, EXPECTED_R012_GAP_PATH)
        gap_r013_path = resolve_safe_repo_file(root, EXPECTED_R013_GAP_PATH)
        if (
            gap_r006_path is None
            or gap_r007_path is None
            or gap_r008_path is None
            or gap_r010_path is None
            or gap_r011_path is None
            or gap_r012_path is None
            or gap_r013_path is None
        ):
            raise ValueError(
        ...
        gap_r011_predecessor = load_json(gap_r011_path)
        gap_r012_predecessor = load_json(gap_r012_path)
        gap_r013_predecessor = load_json(gap_r013_path)
    ...
    expected_gap_predecessor_id = (
        EXPECTED_R013_GAP_DOCUMENT_ID
        if fp011_successor_active
        else EXPECTED_R012_GAP_DOCUMENT_ID
        if fp010_successor_active
        else "WS-IMPLEMENTATION-GAP-ANALYSIS-20260724-011"
    )
    expected_gap_status_counts = (
        EXPECTED_R014_STATUS_COUNTS
        if fp011_successor_active
        else EXPECTED_R013_STATUS_COUNTS
        if fp010_successor_active
        else EXPECTED_R012_STATUS_COUNTS
    )
    directly_reassessed_gap_id = (
        "GAP-019"
        if fp011_successor_active
        else "GAP-015"
        if fp010_successor_active
    ...
    selected_predecessor_gap = (
        gap_r013_predecessor
        if fp011_successor_active
        else gap_r012_predecessor
        if fp010_successor_active
        else gap_r011_predecessor
    )
    require_equal(errors, "Gap report ID", gap.get("metadata", {}).get("report_id"), gap_snapshot.get("report_id"))
    require_equal(errors, "Gap report version", gap.get("metadata", {}).get("version"), expected_gap_version)
    require_equal(errors, "checkpoint Gap report version", gap_snapshot.get("report_version"), expected_gap_version)
    ...
    expected_reassessed_gap_statuses = {
        ...
        "GAP-013": "PARTIAL",
        "GAP-014": "PARTIAL",
        "GAP-015": "PARTIAL" if fp010_successor_active else "MISSING",
        "GAP-016": "PARTIAL",
        "GAP-018": "PARTIAL",
        "GAP-019": "PARTIAL" if fp011_successor_active else "MISSING",
        "GAP-020": "MISSING",
        "GAP-026": "PARTIAL",
        "GAP-027": "PARTIAL",
        "GAP-028": "CONFLICTING",
    ...
    predecessor_assessments = {
        item.get("gap_id"): item
        for item in selected_predecessor_gap.get("assessments", [])
        if isinstance(item, dict)
    }
    changed_gap_ids = {
        gap_id
    ...
    require_equal(
        errors,
        "current Gap assessment change set",
        changed_gap_ids,
        {directly_reassessed_gap_id},
    )
    ...
    require_equal(
        errors,
        "current Gap directly reassessed IDs",
        reassessment_scope.get("directly_reassessed_gap_ids"),
        [directly_reassessed_gap_id],
    )
    require_equal(
        errors,
        "current Gap impact reviewed IDs",
    ...
    for gap_id, expected_status in expected_reassessed_gap_statuses.items():
        ...
        if assessment is None:
            errors.append(f"current Gap report is missing {gap_id}")
            continue
    ...
    if non_not_run_assessments:
        errors.append(
            "current Gap report has formal tests not marked NOT_RUN: "
            f"{non_not_run_assessments}"
        )

    require_equal(errors, "backlog ID", backlog.get("metadata", {}).get("backlog_id"), gap_snapshot.get("backlog_id"))
    require_equal(errors, "backlog version", backlog.get("metadata", {}).get("version"), expected_gap_version)
    require_equal(
        errors,
        ...
        (
            EXPECTED_R013_BACKLOG_DOCUMENT_ID
            if fp011_successor_active
            else EXPECTED_R012_BACKLOG_DOCUMENT_ID
            if fp010_successor_active
            else "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260724-011"
        ),
    )
    ...
    expected_next_work_item_id = (
        EXPECTED_FP011_NEXT_WORK_ITEM_ID
        if fp011_successor_active
        else EXPECTED_FP010_NEXT_WORK_ITEM_ID
        if fp010_successor_active
        else EXPECTED_NEXT_WORK_ITEM_ID
    )
    expected_next_source_policy_id = (
        EXPECTED_FP011_NEXT_SOURCE_POLICY_ID
        if fp011_successor_active
        else EXPECTED_FP010_NEXT_SOURCE_POLICY_ID
        if fp010_successor_active
        else EXPECTED_NEXT_SOURCE_POLICY_ID
    )
    expected_next_gap_id = (
        EXPECTED_FP011_NEXT_GAP_ID
        if fp011_successor_active
        else EXPECTED_FP010_NEXT_GAP_ID
        if fp010_successor_active
        else EXPECTED_NEXT_GAP_ID
    )
    expected_next_action = (
        EXPECTED_FP011_NEXT_ACTION
        if fp011_successor_active
        else EXPECTED_FP010_NEXT_ACTION
        if fp010_successor_active
        else EXPECTED_NEXT_ACTION
    )
    ...
    require_equal(
        ...
        (
            EXPECTED_FP011_LAST_COMPLETED_WORK_SUMMARY
            if fp011_successor_active
            else EXPECTED_FP010_LAST_COMPLETED_WORK_SUMMARY
            if fp010_successor_active
            else EXPECTED_LAST_COMPLETED_WORK_SUMMARY
        ),
    )
    require_equal(
        errors,
        ...
        (
            EXPECTED_FP011_CURRENT_FOCUS
            if fp011_successor_active
            else EXPECTED_FP010_CURRENT_FOCUS
            if fp010_successor_active
            else EXPECTED_CURRENT_FOCUS
        ),
    )
    ...
    snapshot = checkpoint.get("working_tree_snapshot", {})
    expected_controlled_paths = expected_controlled_paths_for_goal_execution(
        goal_execution
    )
    expected_controlled_path_count = len(expected_controlled_paths)
    expected_controlled_path_set_sha256 = path_set_sha256(
    ...
    if not isinstance(managed_paths, list) or not managed_paths:
        ...
        require_equal(
            errors,
            "v2.3 controlled path contract count",
            len(expected_controlled_paths),
            expected_controlled_path_count,
        )
        require_equal(
            errors,
        ...
        if missing:
            ...
            try:
                ...
                require_equal(
                    errors,
                    "v2.3 controlled path-set trust anchor",
                    path_hash,
                    expected_controlled_path_set_sha256,
                )
        ...
        required_current_work_paths |= set(EXPECTED_FP005_IMPLEMENTATION_PATHS)
        required_current_work_paths |= set(EXPECTED_FP005_TRACE_PATHS)
        ...
        required_current_work_paths |= set(EXPECTED_FROZEN_V22_GOAL_PACKAGE_PATHS)
        required_current_work_paths |= set(
            EXPECTED_GOAL_PACKAGE_PATHS
            if transition_event_count >= 16
            else EXPECTED_SEQ13_GOAL_PACKAGE_PATHS
            if transition_event_count >= 11
            else EXPECTED_SEQ8_GOAL_PACKAGE_PATHS
        )
        required_current_work_paths |= set(EXPECTED_CURRENT_DYNAMIC_GOAL_PATHS)
        required_current_work_paths |= set(EXPECTED_GOAL_TOOL_PATHS)
        if fp010_successor_active:
            required_current_work_paths |= set(
                EXPECTED_FP006_IMPLEMENTATION_PATHS
            )
            ...
            required_current_work_paths |= set(EXPECTED_FP006_TRACE_TOOL_PATHS)
        if fp011_successor_active:
            required_current_work_paths |= set(
                EXPECTED_FP010_IMPLEMENTATION_PATHS
            )
            ...
            required_current_work_paths |= set(EXPECTED_FP010_TRACE_TOOL_PATHS)
    ...
    if not isinstance(verification_results, list):
        ...
        expected_handoff_verifications = expected_verification_commands(
            fp010_successor_active
        )
        require_equal(
            errors,
            "handoff verification IDs",
            set(observed_verifications),
            set(expected_handoff_verifications),
        )
        for verification_id, expected in expected_handoff_verifications.items():
    ...
    if not isinstance(blockers, list):
        ...
        expected_implementation_blockers = {
            ...
            "EPIC-02-FP005-FORMAL": "NOT_RUN",
            "EPIC-02-FP005-ENVIRONMENT-FIELD": "NOT_RUN",
            "EPIC-02-FP005-ACTUAL-USER": "NOT_RUN",
            "EPIC-02-FP005-ACTUAL-DEVICE": "NOT_RUN",
            "EPIC-02-FP005-PRODUCTION-PROFILE": "NOT_APPROVED",
            "EPIC-11-RELEASE-SIGNING-DISTRIBUTION": "DEFERRED_TO_EPIC_11",
            "EPIC-12-DEVICE-AND-FORMAL-VERIFICATION": "DEFERRED_TO_EPIC_12",
        }
        if fp010_successor_active:
            expected_implementation_blockers.update(
                {
                    "EPIC-02-FP006-PRODUCTION-MOUNTING-PROFILE": "NOT_APPROVED",
                    "EPIC-02-FP006-PRODUCTION-CAMERA-PROFILE": "NOT_APPROVED",
                    "EPIC-02-FP006-PHONE-MOUNTING-FIELD": "NOT_RUN",
                    "EPIC-02-FP006-ACTUAL-USER": "NOT_RUN",
                    "EPIC-02-FP006-ACTUAL-DEVICE": "NOT_RUN",
                    "EPIC-02-FP006-FORMAL": "NOT_RUN",
                }
            )
