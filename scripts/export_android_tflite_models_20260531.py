...
DEFAULT_COCO = ROOT / "model/artifacts/pretrained/yolo26n.pt"
...
def python_with_ultralytics() -> str:
    ...
    raise RuntimeError("ultralytics is not importable. Install model/requirements.txt or run with project .venv.")
...
def require_tensorflow_for_tflite(python_bin: str) -> None:
    ...
    if result.returncode != 0:
        raise RuntimeError(
            ...
            "Create a Python 3.12 export venv, install model/requirements.txt plus tensorflow<=2.19, "
