...
CONTROL_SUCCESSOR_R009_DIR = (
    Path("docs/control/execution/workstream-transitions/seq70-71")
    / "control-successor-reviews/20260815/R009"
)
CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL = (
    CONTROL_SUCCESSOR_R009_DIR / "assignment.json"
)
CONTROL_SUCCESSOR_R009_RESULT_REL = (
    CONTROL_SUCCESSOR_R009_DIR / "review-result.json"
)
CONTROL_SUCCESSOR_R009_INDEPENDENT_REL = (
    CONTROL_SUCCESSOR_R009_DIR / "independent-review.json"
)
CONTROL_SUCCESSOR_R009_PATHS = (
    CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
    CONTROL_SUCCESSOR_R009_RESULT_REL,
    CONTROL_SUCCESSOR_R009_INDEPENDENT_REL,
)
CONTROL_SUCCESSOR_R009_PINS = {
    CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL: (
...
CONTROL_SUCCESSOR_R009_ROUND_ID = (
    "WS-FP022-SEQ70-71-CURRENT-ACCEPTANCE-CONTROL-SUCCESSOR-20260815-R009"
)
CONTROL_SUCCESSOR_R009_ASSIGNER_ID = (
    "codex-root-current-acceptance-control-r009-assigner-20260815"
)
CONTROL_SUCCESSOR_R009_ASSIGNER_TASK = "/root"
CONTROL_SUCCESSOR_R009_EXECUTOR_ID = (
    "codex-control-successor-r009-implementation-executor-20260815"
)
CONTROL_SUCCESSOR_R009_EXECUTOR_TASK = "/root/r009_control_review"
CONTROL_SUCCESSOR_R009_REVIEWER_ID = (
    "codex-control-successor-r009-independent-reviewer-20260815"
)
CONTROL_SUCCESSOR_R009_REVIEWER_TASK = "/root/r009_final_review"
CONTROL_SUCCESSOR_R009_CHANGED_PATHS = {
    SCRIPT_REL,
    TEST_REL,
    Path("scripts/check_walksafe_project_continuation_v2_4.py"),
    Path("tests/test_walksafe_project_continuation_v2_4.py"),
...
CONTROL_SUCCESSOR_R009_COHORT_PATHS = CONTROL_SUCCESSOR_R008_COHORT_PATHS
CONTROL_SUCCESSOR_R010_DIR = (
    Path("docs/control/execution/workstream-transitions/seq70-71")
    / "control-successor-reviews/20260815/R010"
)
CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL = (
    CONTROL_SUCCESSOR_R010_DIR / "assignment.json"
)
CONTROL_SUCCESSOR_R010_RESULT_REL = (
    CONTROL_SUCCESSOR_R010_DIR / "review-result.json"
)
CONTROL_SUCCESSOR_R010_INDEPENDENT_REL = (
    CONTROL_SUCCESSOR_R010_DIR / "independent-review.json"
)
CONTROL_SUCCESSOR_R010_PATHS = (
    CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
    CONTROL_SUCCESSOR_R010_RESULT_REL,
    CONTROL_SUCCESSOR_R010_INDEPENDENT_REL,
)
CONTROL_SUCCESSOR_R010_PINS = {
    CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL: (
        "fba3cd9619af6fb159f06682b15079caccc69d8ce6959903935b8a196021969d",
        13_933,
    ),
    CONTROL_SUCCESSOR_R010_RESULT_REL: (
        "bd605d25773a7a904724448b0dd5f0d47c8d1acaa04e223aa493659565f8c095",
        13_951,
    ),
    CONTROL_SUCCESSOR_R010_INDEPENDENT_REL: (
        "307bd88a6057d28b282b1d554d276ac420cf60e5448abf47efe61bc7c1c86710",
        14_252,
    ),
}
CONTROL_SUCCESSOR_R010_ROUND_ID = (
    "WS-FP022-SEQ70-71-CURRENT-ACCEPTANCE-CONTROL-SUCCESSOR-20260815-R010"
)
CONTROL_SUCCESSOR_R010_ASSIGNER_ID = (
    "codex-root-current-acceptance-control-r010-assigner-20260815"
)
CONTROL_SUCCESSOR_R010_ASSIGNER_TASK = "/root"
CONTROL_SUCCESSOR_R010_EXECUTOR_ID = (
    "codex-control-successor-r010-implementation-executor-20260815"
)
CONTROL_SUCCESSOR_R010_EXECUTOR_TASK = "/root/r010_control_review"
CONTROL_SUCCESSOR_R010_REVIEWER_ID = (
    "codex-control-successor-r010-independent-reviewer-20260815"
)
CONTROL_SUCCESSOR_R010_REVIEWER_TASK = "/root/r010_final_review"
CONTROL_SUCCESSOR_R010_CHANGED_PATHS = set(CONTROL_SUCCESSOR_R009_CHANGED_PATHS)
CONTROL_SUCCESSOR_R010_COHORT_PATHS = CONTROL_SUCCESSOR_R009_COHORT_PATHS
CONTROL_SUCCESSOR_R011_DIR = (
    Path("docs/control/execution/workstream-transitions/seq70-71")
    / "control-successor-reviews/20260815/R011"
)
CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL = (
    CONTROL_SUCCESSOR_R011_DIR / "assignment.json"
)
CONTROL_SUCCESSOR_R011_RESULT_REL = (
    CONTROL_SUCCESSOR_R011_DIR / "review-result.json"
)
CONTROL_SUCCESSOR_R011_INDEPENDENT_REL = (
    CONTROL_SUCCESSOR_R011_DIR / "independent-review.json"
)
CONTROL_SUCCESSOR_R011_PATHS = (
    CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
    CONTROL_SUCCESSOR_R011_RESULT_REL,
    CONTROL_SUCCESSOR_R011_INDEPENDENT_REL,
)
CONTROL_SUCCESSOR_R011_ROUND_ID = (
    "WS-FP022-SEQ70-71-CURRENT-ACCEPTANCE-CONTROL-SUCCESSOR-20260815-R011"
)
CONTROL_SUCCESSOR_R011_ASSIGNER_ID = (
    "codex-root-current-acceptance-control-r011-assigner-20260815"
)
CONTROL_SUCCESSOR_R011_ASSIGNER_TASK = "/root"
CONTROL_SUCCESSOR_R011_EXECUTOR_ID = (
    "codex-control-successor-r011-implementation-executor-20260815"
)
CONTROL_SUCCESSOR_R011_EXECUTOR_TASK = "/root/r011_control_review"
CONTROL_SUCCESSOR_R011_REVIEWER_ID = (
    "codex-control-successor-r011-independent-reviewer-20260815"
)
CONTROL_SUCCESSOR_R011_REVIEWER_TASK = "/root/r011_final_review"
CONTROL_SUCCESSOR_R011_CHANGED_PATHS = set(CONTROL_SUCCESSOR_R010_CHANGED_PATHS)
CONTROL_SUCCESSOR_R011_COHORT_PATHS = CONTROL_SUCCESSOR_R010_COHORT_PATHS
...
@dataclass(frozen=True)
class ControlSuccessorR009Context:
    root: Path
    current: ReviewContext
    predecessor: ControlSuccessorR008Context
    predecessor_review_bindings: tuple[dict[str, Any], ...]
    control_code_successors: tuple[dict[str, Any], ...]


@dataclass(frozen=True)
class ControlSuccessorR010Context:
    root: Path
    current: ReviewContext
    predecessor: ControlSuccessorR009Context
    predecessor_review_bindings: tuple[dict[str, Any], ...]
    control_code_successors: tuple[dict[str, Any], ...]


@dataclass(frozen=True)
class ControlSuccessorR011Context:
    root: Path
    current: ReviewContext
    predecessor: ControlSuccessorR010Context
    predecessor_review_bindings: tuple[dict[str, Any], ...]
    control_code_successors: tuple[dict[str, Any], ...]
...
def prepare_frozen_control_successor_r008(
    root: Path = ROOT,
) -> tuple[ControlSuccessorR008Context, tuple[dict[str, Any], ...]]:
    """Replay approved R008 from its add-only triad, not current cohort bytes."""

    predecessor, predecessor_bindings = prepare_frozen_control_successor_r007(root)
    documents: dict[Path, dict[str, Any]] = {}
    raw_by_path: dict[Path, bytes] = {}
    require(
        tuple(CONTROL_SUCCESSOR_R008_PINS) == CONTROL_SUCCESSOR_R008_PATHS,
        "control successor R008 pin inventory differs",
    )
    for relative in CONTROL_SUCCESSOR_R008_PATHS:
        raw = _raw(root, relative)
        expected_sha256, expected_length = CONTROL_SUCCESSOR_R008_PINS[relative]
        require(
            bytes_sha256(raw) == expected_sha256 and len(raw) == expected_length,
            f"exact control successor R008 review differs: {relative}",
        )
        document = strict_json_bytes(raw, relative.as_posix())
        documents[relative] = document
        raw_by_path[relative] = raw

    assignment = documents[CONTROL_SUCCESSOR_R008_ASSIGNMENT_REL]
    scope = assignment.get("review_scope")
    require(type(scope) is dict, "control successor R008 scope is missing")
    require(
        scope.get("predecessor_control_successor_review_bindings")
        == list(predecessor_bindings)
        and scope.get("predecessor_current_control_code_cohort_sha256")
        == predecessor.current.control_code_cohort_sha256,
        "control successor R008 predecessor binding differs",
    )
    current_cohort = _validated_binding_cohort(
        scope.get("reviewed_current_control_code_cohort"),
        CONTROL_SUCCESSOR_R008_COHORT_PATHS,
        "control successor R008 current control",
    )
    current_cohort_sha256 = scope.get(
        "reviewed_current_control_code_cohort_sha256"
    )
    require(
        type(current_cohort_sha256) is str
        and current_cohort_sha256 == object_sha256(list(current_cohort)),
        "control successor R008 current control aggregate differs",
    )
    successors = scope.get("reviewed_control_code_successors")
    added = scope.get("reviewed_added_control_code_bindings")
    require(
        type(successors) is list and type(added) is list,
        "control successor R008 semantic delta is missing",
    )
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    ...
    require(
        tuple(successors) == expected_successors
        and {row["path"] for row in expected_successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R008_CHANGED_PATHS}
        and tuple(added) == expected_added,
        "control successor R008 frozen semantic delta differs",
    )
    current = ReviewContext(
        root=root.resolve(strict=True),
        start_review_bindings=predecessor.current.start_review_bindings,
    ...
    frozen = ControlSuccessorR008Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
        control_code_successors=copy.deepcopy(expected_successors),
        added_control_code_bindings=copy.deepcopy(expected_added),
    )
    validate_control_successor_r008_review(root, frozen)
    return frozen, tuple(
        _binding(path, raw_by_path[path]) for path in CONTROL_SUCCESSOR_R008_PATHS
    )


def prepare_control_successor_r009_context(
    root: Path = ROOT,
) -> ControlSuccessorR009Context:
    predecessor, predecessor_bindings = prepare_frozen_control_successor_r008(root)
    current = _r008_live_current_review_context(root)
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    after_by_path = {row["path"]: row for row in current.control_code_cohort}
    expected_paths = tuple(
        path.as_posix() for path in CONTROL_SUCCESSOR_R009_COHORT_PATHS
    )
    require(
        tuple(before_by_path) == expected_paths
        and tuple(after_by_path) == expected_paths,
        "control successor R009 cohort path order differs",
    )
    successors = tuple(
        {
            "path": path.as_posix(),
        ...
        for path in CONTROL_SUCCESSOR_R009_COHORT_PATHS
        if before_by_path[path.as_posix()] != after_by_path[path.as_posix()]
    )
    require(
        {row["path"] for row in successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R009_CHANGED_PATHS},
        "control successor R009 changed path set differs",
    )
    return ControlSuccessorR009Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
...
def _control_successor_r009_scope(
    context: ControlSuccessorR009Context,
) -> dict[str, Any]:
    require(
        len(context.predecessor.current.control_code_cohort) == 23
        and len(context.current.control_code_cohort) == 23
        and len(context.control_code_successors)
        == len(CONTROL_SUCCESSOR_R009_CHANGED_PATHS),
        "control successor R009 cohort counts differ",
    )
    return {
        "predecessor_control_successor_review_bindings": copy.deepcopy(
            list(context.predecessor_review_bindings)
        ...
        "change_purpose": (
            "Bind exact pre/post seq72-76 official validation parity and "
            "fail-closed historical completion replay and queue boundaries "
            "as the ten-path successor of approved R008, without seq77 or "
            "product-code authority."
        ),
        "acceptance": {
            "r008_review_triplet_is_replayed_as_exact_predecessor": True,
            "predecessor_control_cohort_has_exactly_23_paths": True,
            "current_control_cohort_has_exactly_23_paths": True,
            "only_declared_ten_control_paths_changed": True,
            "seq72_76_pre_and_post_official_validation_parity_is_exact": True,
            "historical_completion_replay_is_fail_closed": True,
            "queue_boundary_validation_is_fail_closed": True,
            "seq77_goal_started_remains_excluded": True,
            "product_code_change_remains_excluded": True,
            "completion_formal_external_and_release_credit_remain_zero": True,
        },
    }


def build_control_successor_r009_assignment(
    context: ControlSuccessorR009Context,
    *,
    assigned_at: str,
) -> str:
    assignment = {
        ...
        "goal_id": GOAL_ID,
        "round_id": CONTROL_SUCCESSOR_R009_ROUND_ID,
        "assigned_at": assigned_at,
        "assigner": {
            "role": "INTERNAL_REVIEW_ASSIGNER",
            "agent_instance_id": CONTROL_SUCCESSOR_R009_ASSIGNER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R009_ASSIGNER_TASK,
        },
        "executor": {
            "role": "INTERNAL_IMPLEMENTATION_EXECUTOR",
            "agent_instance_id": CONTROL_SUCCESSOR_R009_EXECUTOR_ID,
            "canonical_task": CONTROL_SUCCESSOR_R009_EXECUTOR_TASK,
        },
        "reviewer": {
            "role": "SEPARATE_INTERNAL_REVIEWER",
            "agent_instance_id": CONTROL_SUCCESSOR_R009_REVIEWER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R009_REVIEWER_TASK,
        },
        "review_scope": _control_successor_r009_scope(context),
        "review_boundary": copy.deepcopy(BOUNDARY),
    }
    raw = json_text(assignment)
    validate_control_successor_r009_assignment(assignment, raw.encode(), context)
    return raw


def validate_control_successor_r009_assignment(
    assignment: Mapping[str, Any],
    raw: bytes,
    context: ControlSuccessorR009Context,
) -> None:
    _validate_control_successor_assignment_envelope(
        assignment,
        raw,
        _control_successor_r009_scope(context),
        round_id=CONTROL_SUCCESSOR_R009_ROUND_ID,
        assigner_id=CONTROL_SUCCESSOR_R009_ASSIGNER_ID,
        assigner_task=CONTROL_SUCCESSOR_R009_ASSIGNER_TASK,
        executor_id=CONTROL_SUCCESSOR_R009_EXECUTOR_ID,
        executor_task=CONTROL_SUCCESSOR_R009_EXECUTOR_TASK,
        reviewer_id=CONTROL_SUCCESSOR_R009_REVIEWER_ID,
        reviewer_task=CONTROL_SUCCESSOR_R009_REVIEWER_TASK,
        label="control successor R009",
    )


def validate_control_successor_r009_result(
    result: Mapping[str, Any],
    raw: bytes,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    ...
    validate_control_successor_r009_assignment(
        assignment, assignment_raw, context
    )
    _validate_control_successor_result_envelope(
        result,
        raw,
        ...
        _control_successor_r009_scope(context),
        round_id=CONTROL_SUCCESSOR_R009_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
        label="control successor R009",
    )


def build_control_successor_r009_independent_review(
    context: ControlSuccessorR009Context,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    result: Mapping[str, Any],
    ...
    validate_control_successor_r009_result(
        result,
        result_raw,
        assignment,
        assignment_raw,
    ...
    return _build_control_successor_independent(
        ...
        round_id=CONTROL_SUCCESSOR_R009_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
        result_rel=CONTROL_SUCCESSOR_R009_RESULT_REL,
    )


def validate_control_successor_r009_review(
    root: Path,
    context: ControlSuccessorR009Context,
) -> None:
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL
    )
    result, result_raw = _document(root, CONTROL_SUCCESSOR_R009_RESULT_REL)
    validate_control_successor_r009_result(
        result,
        result_raw,
        assignment,
    ...
    require(
        _raw(root, CONTROL_SUCCESSOR_R009_INDEPENDENT_REL)
        == build_control_successor_r009_independent_review(
            context,
            assignment,
            assignment_raw,
            result,
        ...
        "control successor R009 independent review differs",
    )


def validated_control_successor_r009_context(
    root: Path = ROOT,
) -> ControlSuccessorR009Context:
    context = prepare_control_successor_r009_context(root)
    validate_control_successor_r009_review(root, context)
    return context


def prepare_frozen_control_successor_r009(
    root: Path = ROOT,
) -> tuple[ControlSuccessorR009Context, tuple[dict[str, Any], ...]]:
    """Replay committed R009 from exact pins without using live cohort bytes."""

    predecessor, predecessor_bindings = prepare_frozen_control_successor_r008(root)
    require(
        tuple(CONTROL_SUCCESSOR_R009_PINS) == CONTROL_SUCCESSOR_R009_PATHS,
        "control successor R009 pin inventory differs",
    )
    documents: dict[Path, dict[str, Any]] = {}
    raw_by_path: dict[Path, bytes] = {}
    for relative in CONTROL_SUCCESSOR_R009_PATHS:
        raw = _raw(root, relative)
        expected_sha256, expected_length = CONTROL_SUCCESSOR_R009_PINS[relative]
        require(
            bytes_sha256(raw) == expected_sha256 and len(raw) == expected_length,
            f"exact control successor R009 review differs: {relative}",
        )
        documents[relative] = strict_json_bytes(raw, relative.as_posix())
        raw_by_path[relative] = raw

    assignment = documents[CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL]
    scope = assignment.get("review_scope")
    require(type(scope) is dict, "control successor R009 scope is missing")
    require(
        scope.get("predecessor_control_successor_review_bindings")
        == list(predecessor_bindings)
        and scope.get("predecessor_current_control_code_cohort_sha256")
        == predecessor.current.control_code_cohort_sha256,
        "control successor R009 predecessor binding differs",
    )
    current_cohort = _validated_binding_cohort(
        scope.get("reviewed_current_control_code_cohort"),
        CONTROL_SUCCESSOR_R009_COHORT_PATHS,
        "control successor R009 current control",
    )
    current_cohort_sha256 = scope.get(
        "reviewed_current_control_code_cohort_sha256"
    )
    require(
        type(current_cohort_sha256) is str
        and current_cohort_sha256 == object_sha256(list(current_cohort)),
        "control successor R009 current control aggregate differs",
    )
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    ...
    require(
        scope.get("reviewed_control_code_successors")
        == list(expected_successors)
        and {row["path"] for row in expected_successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R009_CHANGED_PATHS},
        "control successor R009 frozen semantic delta differs",
    )
    current = ReviewContext(
        root=root.resolve(strict=True),
        start_review_bindings=predecessor.current.start_review_bindings,
    ...
    frozen = ControlSuccessorR009Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
    ...
    assignment_raw = raw_by_path[CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL]
    result = documents[CONTROL_SUCCESSOR_R009_RESULT_REL]
    result_raw = raw_by_path[CONTROL_SUCCESSOR_R009_RESULT_REL]
    validate_control_successor_r009_result(
        result,
        result_raw,
        assignment,
    ...
    require(
        raw_by_path[CONTROL_SUCCESSOR_R009_INDEPENDENT_REL]
        == build_control_successor_r009_independent_review(
            frozen,
            assignment,
            assignment_raw,
    ...
    return frozen, tuple(
        _binding(path, raw_by_path[path]) for path in CONTROL_SUCCESSOR_R009_PATHS
    )


def prepare_control_successor_r010_context(
    root: Path = ROOT,
) -> ControlSuccessorR010Context:
    predecessor, predecessor_bindings = prepare_frozen_control_successor_r009(root)
    current = _r008_live_current_review_context(root)
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    after_by_path = {row["path"]: row for row in current.control_code_cohort}
    expected_paths = tuple(
        path.as_posix() for path in CONTROL_SUCCESSOR_R010_COHORT_PATHS
    )
    require(
        tuple(before_by_path) == expected_paths
        and tuple(after_by_path) == expected_paths,
        "control successor R010 cohort path order differs",
    )
    successors = tuple(
        {
            "path": path.as_posix(),
        ...
        for path in CONTROL_SUCCESSOR_R010_COHORT_PATHS
        if before_by_path[path.as_posix()] != after_by_path[path.as_posix()]
    )
    require(
        {row["path"] for row in successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R010_CHANGED_PATHS},
        "control successor R010 changed path set differs",
    )
    return ControlSuccessorR010Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
...
def _control_successor_r010_scope(
    context: ControlSuccessorR010Context,
) -> dict[str, Any]:
    require(
        len(context.predecessor.current.control_code_cohort) == 23
        and len(context.current.control_code_cohort) == 23
        and len(context.control_code_successors)
        == len(CONTROL_SUCCESSOR_R010_CHANGED_PATHS),
        "control successor R010 cohort counts differ",
    )
    return {
        "predecessor_control_successor_review_bindings": copy.deepcopy(
            list(context.predecessor_review_bindings)
        ...
        "change_purpose": (
            "Bind canonical R029 post-publication reconstruction and current "
            "approved successor/NPC closure parity as the exact ten-path "
            "successor of committed R009, without seq77 or product-code "
            "authority."
        ),
        "acceptance": {
            "r009_review_triplet_is_replayed_from_exact_pins": True,
            "predecessor_control_cohort_has_exactly_23_paths": True,
            "current_control_cohort_has_exactly_23_paths": True,
            "only_declared_ten_control_paths_changed": True,
            "canonical_r029_post_publish_reconstruction_is_exact": True,
            "current_approved_successor_closure_parity_is_exact": True,
            "current_approved_npc_closure_parity_is_exact": True,
            "seq77_goal_started_remains_excluded": True,
            "product_code_change_remains_excluded": True,
            "completion_formal_external_and_release_credit_remain_zero": True,
        },
...
def build_control_successor_r010_assignment(
    context: ControlSuccessorR010Context,
    *,
    assigned_at: str,
) -> str:
    assignment = {
        ...
        "goal_id": GOAL_ID,
        "round_id": CONTROL_SUCCESSOR_R010_ROUND_ID,
        "assigned_at": assigned_at,
        "assigner": {
            "role": "INTERNAL_REVIEW_ASSIGNER",
            "agent_instance_id": CONTROL_SUCCESSOR_R010_ASSIGNER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R010_ASSIGNER_TASK,
        },
        "executor": {
            "role": "INTERNAL_IMPLEMENTATION_EXECUTOR",
            "agent_instance_id": CONTROL_SUCCESSOR_R010_EXECUTOR_ID,
            "canonical_task": CONTROL_SUCCESSOR_R010_EXECUTOR_TASK,
        },
        "reviewer": {
            "role": "SEPARATE_INTERNAL_REVIEWER",
            "agent_instance_id": CONTROL_SUCCESSOR_R010_REVIEWER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R010_REVIEWER_TASK,
        },
        "review_scope": _control_successor_r010_scope(context),
        "review_boundary": copy.deepcopy(BOUNDARY),
    }
    raw = json_text(assignment)
    validate_control_successor_r010_assignment(assignment, raw.encode(), context)
    return raw


def validate_control_successor_r010_assignment(
    assignment: Mapping[str, Any],
    raw: bytes,
    context: ControlSuccessorR010Context,
) -> None:
    _validate_control_successor_assignment_envelope(
        assignment,
        raw,
        _control_successor_r010_scope(context),
        round_id=CONTROL_SUCCESSOR_R010_ROUND_ID,
        assigner_id=CONTROL_SUCCESSOR_R010_ASSIGNER_ID,
        assigner_task=CONTROL_SUCCESSOR_R010_ASSIGNER_TASK,
        executor_id=CONTROL_SUCCESSOR_R010_EXECUTOR_ID,
        executor_task=CONTROL_SUCCESSOR_R010_EXECUTOR_TASK,
        reviewer_id=CONTROL_SUCCESSOR_R010_REVIEWER_ID,
        reviewer_task=CONTROL_SUCCESSOR_R010_REVIEWER_TASK,
        label="control successor R010",
    )


def validate_control_successor_r010_result(
    result: Mapping[str, Any],
    raw: bytes,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    ...
    validate_control_successor_r010_assignment(
        assignment, assignment_raw, context
    )
    _validate_control_successor_result_envelope(
        result,
        ...
        _control_successor_r010_scope(context),
        round_id=CONTROL_SUCCESSOR_R010_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
        label="control successor R010",
    )


def build_control_successor_r010_independent_review(
    context: ControlSuccessorR010Context,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    result: Mapping[str, Any],
    ...
    validate_control_successor_r010_result(
        result,
        result_raw,
        assignment,
        assignment_raw,
    ...
    return _build_control_successor_independent(
        ...
        round_id=CONTROL_SUCCESSOR_R010_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
        result_rel=CONTROL_SUCCESSOR_R010_RESULT_REL,
    )


def validate_control_successor_r010_review(
    root: Path,
    context: ControlSuccessorR010Context,
) -> None:
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL
    )
    result, result_raw = _document(root, CONTROL_SUCCESSOR_R010_RESULT_REL)
    validate_control_successor_r010_result(
        result,
        result_raw,
        assignment,
    ...
    require(
        _raw(root, CONTROL_SUCCESSOR_R010_INDEPENDENT_REL)
        == build_control_successor_r010_independent_review(
            context,
            assignment,
            assignment_raw,
            result,
        ...
        "control successor R010 independent review differs",
    )


def validated_control_successor_r010_context(
    root: Path = ROOT,
) -> ControlSuccessorR010Context:
    context = prepare_control_successor_r010_context(root)
    validate_control_successor_r010_review(root, context)
    return context


def prepare_frozen_control_successor_r010(
    root: Path = ROOT,
) -> tuple[ControlSuccessorR010Context, tuple[dict[str, Any], ...]]:
    """Replay committed R010 from exact pins without using live cohort bytes."""

    predecessor, predecessor_bindings = prepare_frozen_control_successor_r009(root)
    require(
        tuple(CONTROL_SUCCESSOR_R010_PINS) == CONTROL_SUCCESSOR_R010_PATHS,
        "control successor R010 pin inventory differs",
    )
    documents: dict[Path, dict[str, Any]] = {}
    raw_by_path: dict[Path, bytes] = {}
    for relative in CONTROL_SUCCESSOR_R010_PATHS:
        raw = _raw(root, relative)
        expected_sha256, expected_length = CONTROL_SUCCESSOR_R010_PINS[relative]
        require(
            bytes_sha256(raw) == expected_sha256 and len(raw) == expected_length,
            f"exact control successor R010 review differs: {relative}",
        )
        documents[relative] = strict_json_bytes(raw, relative.as_posix())
        raw_by_path[relative] = raw

    assignment = documents[CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL]
    scope = assignment.get("review_scope")
    require(type(scope) is dict, "control successor R010 scope is missing")
    require(
        scope.get("predecessor_control_successor_review_bindings")
        == list(predecessor_bindings)
        and scope.get("predecessor_current_control_code_cohort_sha256")
        == predecessor.current.control_code_cohort_sha256,
        "control successor R010 predecessor binding differs",
    )
    current_cohort = _validated_binding_cohort(
        scope.get("reviewed_current_control_code_cohort"),
        CONTROL_SUCCESSOR_R010_COHORT_PATHS,
        "control successor R010 current control",
    )
    current_cohort_sha256 = scope.get(
        "reviewed_current_control_code_cohort_sha256"
    )
    require(
        type(current_cohort_sha256) is str
        and current_cohort_sha256 == object_sha256(list(current_cohort)),
        "control successor R010 current control aggregate differs",
    )
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    ...
    require(
        ...
        and {row["path"] for row in expected_successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R010_CHANGED_PATHS},
        "control successor R010 frozen semantic delta differs",
    )
    current = ReviewContext(
        root=root.resolve(strict=True),
        start_review_bindings=predecessor.current.start_review_bindings,
    ...
    frozen = ControlSuccessorR010Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
    ...
    assignment_raw = raw_by_path[CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL]
    result = documents[CONTROL_SUCCESSOR_R010_RESULT_REL]
    result_raw = raw_by_path[CONTROL_SUCCESSOR_R010_RESULT_REL]
    validate_control_successor_r010_result(
        result,
        result_raw,
        assignment,
    ...
    require(
        raw_by_path[CONTROL_SUCCESSOR_R010_INDEPENDENT_REL]
        == build_control_successor_r010_independent_review(
            frozen,
            assignment,
            assignment_raw,
    ...
    return frozen, tuple(
        _binding(path, raw_by_path[path]) for path in CONTROL_SUCCESSOR_R010_PATHS
    )


def prepare_control_successor_r011_context(
    root: Path = ROOT,
) -> ControlSuccessorR011Context:
    predecessor, predecessor_bindings = prepare_frozen_control_successor_r010(root)
    current = _r008_live_current_review_context(root)
    before_by_path = {
        row["path"]: row for row in predecessor.current.control_code_cohort
    }
    after_by_path = {row["path"]: row for row in current.control_code_cohort}
    expected_paths = tuple(
        path.as_posix() for path in CONTROL_SUCCESSOR_R011_COHORT_PATHS
    )
    require(
        tuple(before_by_path) == expected_paths
        and tuple(after_by_path) == expected_paths,
        "control successor R011 cohort path order differs",
    )
    successors = tuple(
        {
            "path": path.as_posix(),
        ...
        for path in CONTROL_SUCCESSOR_R011_COHORT_PATHS
        if before_by_path[path.as_posix()] != after_by_path[path.as_posix()]
    )
    require(
        {row["path"] for row in successors}
        == {path.as_posix() for path in CONTROL_SUCCESSOR_R011_CHANGED_PATHS},
        "control successor R011 changed path set differs",
    )
    return ControlSuccessorR011Context(
        root=root.resolve(strict=True),
        current=current,
        predecessor=predecessor,
        predecessor_review_bindings=predecessor_bindings,
...
def _control_successor_r011_scope(
    context: ControlSuccessorR011Context,
) -> dict[str, Any]:
    require(
        len(context.predecessor.current.control_code_cohort) == 23
        and len(context.current.control_code_cohort) == 23
        and len(context.control_code_successors)
        == len(CONTROL_SUCCESSOR_R011_CHANGED_PATHS),
        "control successor R011 cohort counts differ",
    )
    return {
        "predecessor_control_successor_review_bindings": copy.deepcopy(
            list(context.predecessor_review_bindings)
        ...
        "change_purpose": (
            "Bind the actual R003 managed-closure lineage and current approved "
            "NPC physical parity as the exact ten-path successor of committed "
            "R010, without seq77 or product-code authority."
        ),
        "acceptance": {
            "r010_review_triplet_is_replayed_from_exact_pins": True,
            "predecessor_control_cohort_has_exactly_23_paths": True,
            "current_control_cohort_has_exactly_23_paths": True,
            "only_declared_ten_control_paths_changed": True,
            "actual_r003_managed_closure_lineage_is_exact": True,
            "current_approved_npc_physical_parity_is_exact": True,
            "seq77_goal_started_remains_excluded": True,
            "product_code_change_remains_excluded": True,
            "completion_formal_external_and_release_credit_remain_zero": True,
        },
...
def build_control_successor_r011_assignment(
    context: ControlSuccessorR011Context,
    *,
    assigned_at: str,
) -> str:
    assignment = {
        ...
        "goal_id": GOAL_ID,
        "round_id": CONTROL_SUCCESSOR_R011_ROUND_ID,
        "assigned_at": assigned_at,
        "assigner": {
            "role": "INTERNAL_REVIEW_ASSIGNER",
            "agent_instance_id": CONTROL_SUCCESSOR_R011_ASSIGNER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R011_ASSIGNER_TASK,
        },
        "executor": {
            "role": "INTERNAL_IMPLEMENTATION_EXECUTOR",
            "agent_instance_id": CONTROL_SUCCESSOR_R011_EXECUTOR_ID,
            "canonical_task": CONTROL_SUCCESSOR_R011_EXECUTOR_TASK,
        },
        "reviewer": {
            "role": "SEPARATE_INTERNAL_REVIEWER",
            "agent_instance_id": CONTROL_SUCCESSOR_R011_REVIEWER_ID,
            "canonical_task": CONTROL_SUCCESSOR_R011_REVIEWER_TASK,
        },
        "review_scope": _control_successor_r011_scope(context),
        "review_boundary": copy.deepcopy(BOUNDARY),
    }
    raw = json_text(assignment)
    validate_control_successor_r011_assignment(assignment, raw.encode(), context)
    return raw


def validate_control_successor_r011_assignment(
    assignment: Mapping[str, Any],
    raw: bytes,
    context: ControlSuccessorR011Context,
) -> None:
    _validate_control_successor_assignment_envelope(
        assignment,
        raw,
        _control_successor_r011_scope(context),
        round_id=CONTROL_SUCCESSOR_R011_ROUND_ID,
        assigner_id=CONTROL_SUCCESSOR_R011_ASSIGNER_ID,
        assigner_task=CONTROL_SUCCESSOR_R011_ASSIGNER_TASK,
        executor_id=CONTROL_SUCCESSOR_R011_EXECUTOR_ID,
        executor_task=CONTROL_SUCCESSOR_R011_EXECUTOR_TASK,
        reviewer_id=CONTROL_SUCCESSOR_R011_REVIEWER_ID,
        reviewer_task=CONTROL_SUCCESSOR_R011_REVIEWER_TASK,
        label="control successor R011",
    )


def validate_control_successor_r011_result(
    result: Mapping[str, Any],
    raw: bytes,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    ...
    validate_control_successor_r011_assignment(
        assignment, assignment_raw, context
    )
    _validate_control_successor_result_envelope(
        result,
        ...
        _control_successor_r011_scope(context),
        round_id=CONTROL_SUCCESSOR_R011_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
        label="control successor R011",
    )


def build_control_successor_r011_independent_review(
    context: ControlSuccessorR011Context,
    assignment: Mapping[str, Any],
    assignment_raw: bytes,
    result: Mapping[str, Any],
    ...
    validate_control_successor_r011_result(
        result,
        result_raw,
        assignment,
        assignment_raw,
    ...
    return _build_control_successor_independent(
        ...
        round_id=CONTROL_SUCCESSOR_R011_ROUND_ID,
        assignment_rel=CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
        result_rel=CONTROL_SUCCESSOR_R011_RESULT_REL,
    )


def validate_control_successor_r011_review(
    root: Path,
    context: ControlSuccessorR011Context,
) -> None:
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL
    )
    result, result_raw = _document(root, CONTROL_SUCCESSOR_R011_RESULT_REL)
    validate_control_successor_r011_result(
        result,
        result_raw,
        assignment,
    ...
    require(
        _raw(root, CONTROL_SUCCESSOR_R011_INDEPENDENT_REL)
        == build_control_successor_r011_independent_review(
            context,
            assignment,
            assignment_raw,
            result,
...
def validated_control_successor_r011_context(
    root: Path = ROOT,
) -> ControlSuccessorR011Context:
    context = prepare_control_successor_r011_context(root)
    validate_control_successor_r011_review(root, context)
    return context
...
def validated_control_successor_managed_closure_sources(
    ...
    """Return R004 closure sources after validating the latest R011 chain."""

    return validated_control_successor_managed_closure_sources_by_round(root)[
        "R004"
    ]


def validated_control_successor_managed_closure_sources_by_round(
    root: Path = ROOT,
) -> dict[str, tuple[dict[str, Any], ...]]:
    """Expose actual R002-R004 closure sources through validated R011."""

    cursor: Any = validated_control_successor_r011_context(root)
    r004: ControlSuccessorR004Context | None = None
    while cursor is not None:
        if isinstance(cursor, ControlSuccessorR004Context):
            r004 = cursor
            break
        cursor = getattr(cursor, "predecessor", None)
    require(r004 is not None, "validated R011 chain omits control successor R004")
    r003 = r004.predecessor
    require(
        isinstance(r003, ControlSuccessorR003Context),
        "validated R011 managed closure lineage differs",
    )
    return {
        "R002": tuple(
            copy.deepcopy(row)
            for row in r003.predecessor_managed_closure_source_successors
        ),
        "R003": tuple(
            copy.deepcopy(row)
            for row in r003.managed_closure_source_successors
        ),
        "R004": tuple(
            copy.deepcopy(row)
            for row in r004.managed_closure_source_successors
        ),
    }


def validate_post_review(root: Path = ROOT) -> ReviewContext:
    return validated_control_successor_r011_context(root).current
...
def write_control_successor_r009_assignment(root: Path) -> None:
    context = prepare_control_successor_r009_context(root)
    _write_add_only(
        root,
        CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
        build_control_successor_r009_assignment(context, assigned_at=_now()),
    )


def write_control_successor_r009_independent(root: Path) -> None:
    context = prepare_control_successor_r009_context(root)
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL
    )
...
def write_control_successor_r010_assignment(root: Path) -> None:
    context = prepare_control_successor_r010_context(root)
    _write_add_only(
        root,
        CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
        build_control_successor_r010_assignment(context, assigned_at=_now()),
    )


def write_control_successor_r010_independent(root: Path) -> None:
    context = prepare_control_successor_r010_context(root)
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL
    )
...
def write_control_successor_r011_assignment(root: Path) -> None:
    context = prepare_control_successor_r011_context(root)
    _write_add_only(
        root,
        CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
        build_control_successor_r011_assignment(context, assigned_at=_now()),
    )


def write_control_successor_r011_independent(root: Path) -> None:
    context = prepare_control_successor_r011_context(root)
    assignment, assignment_raw = _document(
        root, CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL
    )
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    mode.add_argument(
        "--write-control-successor-r011-assignment",
        action="store_true",
    )
    mode.add_argument(
        "--check-control-successor-r011-assignment",
        action="store_true",
    )
    mode.add_argument(
        "--check-control-successor-r011-review-result",
        action="store_true",
    )
    mode.add_argument(
        "--write-control-successor-r011-independent",
        action="store_true",
    )
    mode.add_argument(
        "--check-control-successor-r011-post-review",
        action="store_true",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        if args.write_assignment:
            ...
            validated_control_successor_r008_context(root)
        elif args.write_control_successor_r009_assignment:
            write_control_successor_r009_assignment(root)
        elif args.check_control_successor_r009_assignment:
            context = prepare_control_successor_r009_context(root)
            assignment, raw = _document(
                root,
                CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
            )
            validate_control_successor_r009_assignment(assignment, raw, context)
        elif args.check_control_successor_r009_review_result:
            context = prepare_control_successor_r009_context(root)
            assignment, assignment_raw = _document(
                root,
                CONTROL_SUCCESSOR_R009_ASSIGNMENT_REL,
        ...
        elif args.write_control_successor_r009_independent:
            write_control_successor_r009_independent(root)
        elif args.check_control_successor_r009_post_review:
            validated_control_successor_r009_context(root)
        elif args.write_control_successor_r010_assignment:
            write_control_successor_r010_assignment(root)
        elif args.check_control_successor_r010_assignment:
            context = prepare_control_successor_r010_context(root)
            assignment, raw = _document(
                root,
                CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
            )
            validate_control_successor_r010_assignment(assignment, raw, context)
        elif args.check_control_successor_r010_review_result:
            context = prepare_control_successor_r010_context(root)
            assignment, assignment_raw = _document(
                root,
                CONTROL_SUCCESSOR_R010_ASSIGNMENT_REL,
        ...
        elif args.write_control_successor_r010_independent:
            write_control_successor_r010_independent(root)
        elif args.check_control_successor_r010_post_review:
            validated_control_successor_r010_context(root)
        elif args.write_control_successor_r011_assignment:
            write_control_successor_r011_assignment(root)
        elif args.check_control_successor_r011_assignment:
            context = prepare_control_successor_r011_context(root)
            assignment, raw = _document(
                root,
                CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
            )
            validate_control_successor_r011_assignment(assignment, raw, context)
        elif args.check_control_successor_r011_review_result:
            context = prepare_control_successor_r011_context(root)
            assignment, assignment_raw = _document(
                root,
                CONTROL_SUCCESSOR_R011_ASSIGNMENT_REL,
        ...
        elif args.write_control_successor_r011_independent:
            write_control_successor_r011_independent(root)
        elif args.check_control_successor_r011_post_review:
            validated_control_successor_r011_context(root)
        else:
