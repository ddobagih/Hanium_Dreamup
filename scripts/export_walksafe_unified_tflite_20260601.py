...
def python_with_ultralytics(explicit_python: str | None) -> str:
    ...
    raise RuntimeError("ultralytics is not importable. Install model/requirements.txt or pass --python.")
...
def require_tensorflow_for_tflite(python_bin: str) -> None:
    ...
    if result.returncode != 0:
        raise RuntimeError(
            ...
            "Use a Python 3.12 export venv with model/requirements.txt plus tensorflow<=2.19."
        )
