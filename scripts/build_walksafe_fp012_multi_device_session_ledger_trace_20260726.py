#!/usr/bin/env python3
"""Build the focused FP-012 multi-device session-ledger implementation trace."""
...
BUILDER_TEST = (
    ROOT / "tests/test_walksafe_fp012_multi_device_session_ledger_trace_20260726.py"
)
...
GOAL_PATH = (
    ...
    "epic-02-fp012-multi-device-session-ledger-r001.md"
)
...
FOCUSED_COMMAND = "mkdir -p app/build/test-results/testDebugUnitTest && find app/build/test-results/testDebugUnitTest -mindepth 1 -delete && ./gradlew :app:testDebugUnitTest --tests '*MainActivityFp012StaticTest' --tests '*PermissionSessionLifecycleStaticTest' --tests '*GatewayWalkSessionTest' --tests '*WalkSessionLifecycleFp012Test' --rerun-tasks --offline --no-daemon --max-workers=1 -Dkotlin.compiler.execution.strategy=in-process"
FULL_ANDROID_COMMAND = 'mkdir -p app/build/test-results/testDebugUnitTest && find app/build/test-results/testDebugUnitTest -mindepth 1 -delete && ./gradlew :app:testDebugUnitTest :app:assembleDebug :app:lintDebug --rerun-tasks --offline --no-daemon --max-workers=1 -Dkotlin.compiler.execution.strategy=in-process'
FULL_ANDROID_MIN_TESTS = 691
...
CONTROL_PLANE_COMMAND = '/home/ddobagi/.local/share/hanium-dreamup/walksafe-general-cpu-verify-20260715/bin/python -m py_compile scripts/build_walksafe_fp012_multi_device_session_ledger_trace_20260726.py && /home/ddobagi/.local/share/hanium-dreamup/walksafe-general-cpu-verify-20260715/bin/python -m pytest -q tests/test_walksafe_fp012_multi_device_session_ledger_trace_20260726.py'

GAP_R019_JSON = (
    ROOT / "docs/control/audits/walksafe-implementation-gap-analysis-20260726-r019.json"
)
BACKLOG_R019_JSON = (
    ROOT / "docs/control/audits/walksafe-implementation-remediation-backlog-20260726-r019.json"
)
FP016_OVERLAY_JSON = (
    ROOT / "docs/control/execution/"
    "walksafe-epic-02-fp016-camera-centered-buttonless-screen-active-ledger-"
    "overlay-20260726-r001.json"
)
GAP_R020_JSON = (
    ROOT / "docs/control/audits/walksafe-implementation-gap-analysis-20260726-r020.json"
)
GAP_R020_MD = GAP_R020_JSON.with_suffix(".md")
BACKLOG_R020_JSON = (
    ROOT / "docs/control/audits/"
    "walksafe-implementation-remediation-backlog-20260726-r020.json"
)
BACKLOG_R020_MD = BACKLOG_R020_JSON.with_suffix(".md")
FP012_OVERLAY_JSON = (
    ROOT / "docs/control/execution/"
    "walksafe-epic-02-fp012-multi-device-session-ledger-active-ledger-"
    "overlay-20260726-r001.json"
)
FP012_OVERLAY_MD = FP012_OVERLAY_JSON.with_suffix(".md")
CHECKPOINT = ROOT / "docs/control/walksafe-project-continuation-checkpoint.json"
START_GATE_RECEIPT = (
    ROOT / "docs/control/execution/goal-gates/"
    "WS-GOAL-GRAPH-V2-4-GOAL-STARTED-FP012-20260726-001/"
...
EXPECTED_PREDECESSOR_SHA256 = {
    GAP_R019_JSON: "99b3b53eaa7b86fbead93db74a86ac25199ff3c0c6cf443d7d19af0d8fe7a9f1",
    BACKLOG_R019_JSON: "0c95156951ffcf7004fc92fbd6ca2cffe04febcea86ac457195fb10551ee6e62",
    FP016_OVERLAY_JSON: "df50b7273fe16b009caa1ea64446450001e225fb8a3bd9489451d2a3107dfc61",
}
EXPECTED_GOAL_SHA256 = '4f85f016683176ca38de6024cd7fea4c09b9cf65e8c3318d27b785120d634c3f'
EXPECTED_START_GATE_RECEIPT_SHA256 = 'e9f05c4d8f1e73700c8127f5b1affed9d31cdcba125727ff43ac2d768c8776fa'
EXPECTED_START_GATE_RECEIPT_ID = 'WS-GOAL-GRAPH-V2-4-IMPLEMENTATION-START-GATE-FP012-20260726-001'
EXPECTED_START_GATE_REPOSITORY_STATE_LOG_SHA256 = '1373209b5f29a4aa037779e59313f70c906da34294d7fc40d25716631ffb6a02'
EXPECTED_PINNED_HEAD = "a3ad7eead6b5d834d3e0675422475a9aad351e3d"
EXPECTED_EXECUTION_EVENT_SEQUENCE = 29
EXPECTED_EXECUTION_EVENT_ID = 'WS-GOAL-GRAPH-V2-4-GOAL-STARTED-FP012-20260726-001'
EXPECTED_EXECUTION_EVENT_SHA256 = '4bb8af73254d6bd4c1c2d326aa3546c4d809b7e4d7610aac42d3e9837e7ab868'
EXPECTED_EXECUTION_STARTED_AT = '2026-07-26T09:07:34+09:00'
EXECUTOR_ID = 'CODEX-FP012-MULTI-DEVICE-SESSION-LEDGER-IMPLEMENTER-20260726-001'
EXECUTOR_TASK = "/root"
EXPECTED_REVIEWER_ID = 'WS-FP012-INDEPENDENT-REVIEWER-001'
EXPECTED_REVIEWER_TASK = '/root/fp012_final_evidence_review'
...
EXPECTED_REVIEW_BOUNDARY = {'separate_internal_review_pass': True, 'external_independence_claimed': False, 'formal_tests_remain_not_run': True, 'actual_user_tests_remain_not_run': True, 'actual_voice_confirmation_tests_remain_not_run': True, 'actual_device_tests_remain_not_run': True, 'actual_unstable_network_tests_remain_not_run': True, 'operational_lease_policy_approval_remains_not_run': True, 'production_deployment_remains_not_run': True, 'release_remains_not_eligible': True}

IMPLEMENTATION_PATHS = ('apps/android/app/src/main/java/kr/co/hanium/dreamup/walksafe/MainActivity.kt', 'apps/android/app/src/main/java/kr/co/hanium/dreamup/walksafe/network/GatewayFieldSession.kt', 'apps/android/app/src/main/java/kr/co/hanium/dreamup/walksafe/network/GatewayWalkSession.kt', 'apps/android/app/src/test/java/kr/co/hanium/dreamup/walksafe/MainActivityFp012StaticTest.kt', 'apps/android/app/src/test/java/kr/co/hanium/dreamup/walksafe/PermissionSessionLifecycleStaticTest.kt', 'apps/android/app/src/test/java/kr/co/hanium/dreamup/walksafe/network/GatewayWalkSessionTest.kt', 'apps/android/app/src/test/java/kr/co/hanium/dreamup/walksafe/session/WalkSessionLifecycleFp012Test.kt', 'apps/android-gateway/src/field-walk-ledger.ts', 'apps/android-gateway/src/routes.ts', 'apps/android-gateway/src/auth.ts', 'apps/android-gateway/openapi.json', 'apps/android-gateway/test/field-walk-ledger.test.ts', 'apps/android-gateway/test/gateway-contract.test.ts', 'configs/walksafe_product_boundary_20260722.json', 'deploy/nginx/walksafe-android-gateway.conf.example')
TOOLING_PATHS = ('scripts/build_walksafe_fp012_multi_device_session_ledger_trace_20260726.py', 'tests/test_walksafe_fp012_multi_device_session_ledger_trace_20260726.py', 'scripts/check_walksafe_android_gateway_boundary_20260723.py')
...
def validate_execution_history(goal_execution: dict[str, Any]) -> dict[str, Any]:
    ...
    require(
        ...
        "FP-012 execution event is not exact-one",
    )
    ...
    require(
        ...
        "FP-012 execution event differs",
    )
    return execution
...
def validate_inputs(
    ...
    gap = base.load_json(GAP_R019_JSON)
    backlog = base.load_json(BACKLOG_R019_JSON)
    overlay = base.load_json(FP016_OVERLAY_JSON)
    require(
        gap.get("metadata", {}).get("report_id")
        == "WS-IMPLEMENTATION-GAP-ANALYSIS-20260726-019",
        "r019 gap identity differs",
    )
    require(
        backlog.get("metadata", {}).get("backlog_id")
        == "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260726-019",
        "r019 backlog identity differs",
    )
    require(
        overlay.get("metadata", {}).get("overlay_id")
        == "WS-EPIC-02-FP016-CAMERA-CENTERED-BUTTONLESS-SCREEN-ACTIVE-LEDGER-OVERLAY-20260726-001",
        "FP-016 predecessor overlay identity differs",
    )
...
def completion_boundary() -> dict[str, Any]:
    return {
        "formal_test_ids": [f"TC-FP-012-{index:02d}" for index in range(1, 6)],
...
def build_implementation(
    *,
    ...
    return {
        "schema_version": "1.0",
        "document_id": "WS-FP012-MULTI-DEVICE-SESSION-LEDGER-IMPLEMENTATION-20260726-001",
        "goal_id": GOAL_ID,
        ...
        "implemented_controls": [
            "multiple device login sessions remain valid while each account has exactly one active walk lease",
            "a second-device start is atomically blocked until an explicit transfer decision is recorded",
            "the server-authoritative ledger binds account, device, walk, lease and event-time identifiers",
            "an approved transfer terminates the predecessor lease before activating the successor lease",
            "a denied or absent transfer confirmation preserves the predecessor walk and blocks the successor",
            "persistent offline predecessor or lease-conflict failure transitions the walk session to SAFE_STOP",
            "duplicate requests and retries preserve the single-active-walk invariant",
            "reports and walk data use idempotent identifiers and are neither overwritten nor duplicated",
            "Android and Gateway contracts bind the same account-device-walk lease transition model",
            "focused Android and Gateway regressions cover login preservation, atomic blocking, transfer, retry and offline convergence",
            "the trace binds exact product-fifteen and tooling-three scopes as one canonical exact-eighteen content set",
        ],
        "remaining_implementation_boundaries":
 [
            "TC-FP-012-01 through TC-FP-012-05 and the 279 formal tests were not run",
            "actual voice confirmation, Android multi-device and unstable-network scenarios were not tested",
            "actual unstable-network verification was not performed",
            "the operational server lease policy was not approved",
...
def checked_log(
    ...
    *,
    ...
    execution_started_at = parse_aware_timestamp(
        ...
        "FP-012 execution start timestamp",
    )
    require(
        started_at >= execution_started_at,
        f"{name} log starts before the FP-012 execution event",
    )
    require(
        started_at <= ended_at,
    ...
    *,
    ...
    checks = [
        checked_log(
            ...
            name="FP-012 focused Android multi-device session-ledger tests",
        ...
        checked_log(
            ...
            name="Android Gateway multi-device-session-ledger typecheck and tests",
        ...
        checked_log(
            ...
            name="FP-012 deterministic trace regression",
    ...
    return {
        "schema_version": "1.0",
        "document_id": "WS-FP012-MULTI-DEVICE-SESSION-LEDGER-VERIFICATION-20260726-001",
        "goal_id": GOAL_ID,
...
def build_review(
    ...
    return {
        "schema_version": "1.0",
        "document_id": "WS-FP012-MULTI-DEVICE-SESSION-LEDGER-INTERNAL-REVIEW-20260726-001",
...
def build_receipt(
    ...
    return {
        "schema_version": "1.0",
        "document_id": (
            "WS-FP012-MULTI-DEVICE-SESSION-LEDGER-WORK-ITEM-COMPLETION-20260726-001"
        ),
...
def build_gap(
    ...
    require(
        ...
        and counts["MISSING"] == 12
        and counts["PARTIAL"] == 30
        and counts["IMPLEMENTED"] == 0,
        "r019 status counts differ",
    )
    report = deepcopy(predecessor_gap)
    report.pop("report_content_sha256", None)
    report["metadata"] = {
        "report_id": "WS-IMPLEMENTATION-GAP-ANALYSIS-20260726-020",
        "version": "0.20.0",
    ...
    report["purpose"] = (
        "FP-012 server-authoritative multi-device session and single-active-walk "
        "ledger controls are implemented and verified internally. GAP-021 "
    ...
    report["source_bindings"] = predecessor_gap["source_bindings"] + [
        {**base.file_record(BUILDER), "name": "fp012_session_ledger_trace_builder"},
        {**base.file_record(BUILDER_TEST), "name": "fp012_session_ledger_builder_test"},
        {**base.file_record(START_GATE_RECEIPT), "name": "fp012_start_gate"},
        {
            **base.file_record(START_GATE_REPOSITORY_STATE_LOG),
            "name": "fp012_gate_repository_state",
        },
        generated_record(
            IMPLEMENTATION_JSON,
            implementation_text,
            name="fp012_session_ledger_implementation",
        ),
        generated_record(
            VERIFICATION_JSON,
            verification_text,
            name="fp012_session_ledger_verification",
        ),
    ]
    report["source_binding_sha256"] = base.object_sha256(report["source_bindings"])
    files = implementation_files()
    snapshot = {
        "scope_kind": "EPIC_02_FP012_EXACT_18_PATH_SET",
    ...
    report["summary"] = {
        **predecessor_gap["summary"],
        ...
        "headline": (
            "GAP-021 internal multi-device session-ledger controls are verified, "
            "but formal, actual voice, multi-device, unstable-network, operational and release evidence "
    ...
    evidence_id = "EVD-FP012-MULTI-DEVICE-SESSION-LEDGER-20260726"
    report["evidence_catalog"] = predecessor_gap["evidence_catalog"] + [
        {
            "evidence_id": evidence_id,
            "kind": "INTERNAL_PRODUCER_RESULT",
            "claim": (
                "FP-012 repository-internal multi-device login, atomic single-active-walk "
                "lease, confirmed transfer, idempotency and offline convergence regressions"
            ),
    ...
    matches = [
        item for item in report["assessments"] if item["gap_id"] == "GAP-021"
    ]
    require(len(matches) == 1, "GAP-021 assessment count differs")
    assessment = matches[0]
    require(
        assessment.get("source_policy_id") == "FP-012"
        and assessment.get("status") == "MISSING",
        "GAP-021 predecessor assessment differs",
    )
    assessment["status"] = "PARTIAL"
    assessment["formal_test_status"] = "NOT_RUN"
    assessment["current_implementation_in_plain_language"] = (
        "Android and Gateway retain independent device login sessions while a "
        "server-authoritative account ledger atomically permits one active walk. "
        "A second device remains blocked before confirmation, approved transfer "
        "terminates the predecessor lease first, duplicate requests are idempotent, "
        "and offline predecessors converge to termination or approved lease expiry."
    )
    assessment["rationale"] = (
        "The exact 18-path internal implementation and five canonical regression "
        "layers passed. Formal tests, actual voice confirmation, Android multi-device "
        "and unstable-network verification, operational lease-policy approval, deployment and "
        "release gates remain NOT_RUN."
    )
    assessment["evidence_ids"] = list(
        dict.fromkeys([*assessment.get("evidence_ids", []), evidence_id])
    )
    assessment["fp012_reassessment"] = {
        "goal_id": GOAL_ID,
    ...
    carried_ids = [
        ...
        if item["gap_id"] != "GAP-021"
    ]
    require(len(carried_ids) == 67, "r019 carry-forward gap count differs")
    report["reassessment_scope"] = {
        "mode": "FOCUSED_EPIC02_FP012_GAP021_REASSESSMENT_WITH_R019_CARRY_FORWARD",
        "directly_reassessed_gap_ids": ["GAP-021"],
        "impact_reviewed_gap_ids": [],
        "reviewed_gap_ids": ["GAP-021"],
        "carried_forward_gap_count": 67,
        "carried_forward_gap_ids": carried_ids,
        "carry_forward_warning": (
            "The other 67 assessments are preserved from r019."
        ),
        "next_adjacent_gap": {
            "gap_id": "GAP-056",
            "source_policy_id": "FP-047",
            "reason": "EPIC-03 deterministic execution order advances to order 19.",
        },
        "predecessor": {
            "report_id": predecessor_gap["metadata"]["report_id"],
            "path": relative(GAP_R019_JSON),
            "file_sha256": EXPECTED_PREDECESSOR_SHA256[GAP_R019_JSON],
            "evidence_count": len(predecessor_gap["evidence_catalog"]),
            "revalidated_wholesale_in_r020": False,
        },
    }
    ...
    report["limitations"] = [
        "Only GAP-021 is directly reassessed; 67 assessments are carried from r019.",
        "TC-FP-012-01 through TC-FP-012-05 and all 279 formal tests are NOT_RUN.",
        "Actual-user, voice-confirmation user and Android-device verification is NOT_RUN.",
        "unstable-network verification and operational lease-policy approval are NOT_RUN.",
...
def build_backlog(
    ...
    backlog["metadata"] = {
        "backlog_id": "WS-IMPLEMENTATION-REMEDIATION-BACKLOG-20260726-020",
        "version": "0.20.0",
        "status": "DRAFT_DIAGNOSTIC_COMPLETE",
    ...
    backlog["source_predecessor"] = {
        "path": relative(BACKLOG_R019_JSON),
        "file_sha256": EXPECTED_PREDECESSOR_SHA256[BACKLOG_R019_JSON],
    ...
    matching = [
        ...
        if item.get("source_policy_id") == "FP-012"
    ]
    require(len(matching) == 1, "FP-012 backlog action count differs")
    require(matching[0].get("status") == "MISSING", "FP-012 backlog status differs")
    matching[0]["status"] = "PARTIAL"
    matching[0]["action"] = (
        "Connect the verified internal multi-device session-ledger controls to actual "
        "voice-confirmation, Android multi-device, unstable-network, operational "
        "lease-policy, formal and release verification."
    )
    ...
    epic["current_status_reason"] = (
        "FP-012 internal multi-device session-ledger single-active-walk ledger controls are verified; "
        "FP-047 and later policies plus external and release verification remain."
    )
    next_row = next(
        item
        for item in backlog["next_action_sequence"]
...
def build_overlay(
    ...
    return {
        ...
        "metadata": {
            ...
            "title": "EPIC-02 FP-012 multi-device session-ledger successor overlay",
        },
        "authority_boundary": {
            ...
            "formal_test_completion_claimed": False,
            "actual_voice_confirmation_completion_claimed": False,
            "actual_unstable_network_completion_claimed": False,
            "actual_device_completion_claimed": False,
            "operational_lease_policy_approval_completion_claimed": False,
        ...
        "source_bindings": {
            "predecessor_overlay": base.file_record(FP016_OVERLAY_JSON),
            "implementation_record": generated_record(
                IMPLEMENTATION_JSON,
                implementation_text,
                name="fp012_implementation",
            ),
            "verification_result": generated_record(
                VERIFICATION_JSON,
                verification_text,
                name="fp012_verification",
            ),
...
def build_successor(
    ...
    return {
        "schema_version": "1.0",
        "document_id": "WS-FP012-MULTI-DEVICE-SESSION-LEDGER-SUCCESSOR-20260726-001",
        "goal_id": GOAL_ID,
...
def gap_markdown(value: dict[str, Any]) -> str:
    row = next(item for item in value["assessments"] if item["gap_id"] == "GAP-021")
    return (
        ...
        "- TC-FP-012-01~05·정식 279개·실제 음성 확인·다중 기기·불안정 네트워크·"
        "운영 lease 정책·운영 배포: `NOT_RUN`\n"
...
def overlay_markdown(value: dict[str, Any]) -> str:
    return (
        "# EPIC-02 FP-012 다중 기기 세션 원장 Active ledger overlay\n\n"
        f"- Overlay: `{value['metadata']['overlay_id']}`\n"
        "- FP-012 내부 다중 기기·단일 활성 보행 원장 구현·검증: `PARTIAL_IMPLEMENTATION_VERIFIED`\n"
        "- 정식 279개·실제 음성 확인·다중 기기·불안정 네트워크·운영 lease·배포: `NOT_RUN`\n"
        "- 출시 Gate 5개: `NOT_RUN` / 미면제\n"
        "- 출시: `NOT_ELIGIBLE`\n"
    )
...
def build_outputs(
    *,
    ...
    non_receipt_outputs = {
        ...
        GAP_R020_JSON: gap_text,
        GAP_R020_MD: gap_markdown(gap),
        BACKLOG_R020_JSON: backlog_text,
        BACKLOG_R020_MD: backlog_markdown(backlog),
        FP012_OVERLAY_JSON: json_text(overlay),
        FP012_OVERLAY_MD: overlay_markdown(overlay),
    }
    output_manifest = [
        {
            "path": relative(path),
    ...
    outputs = {
        ...
        GAP_R020_JSON: gap_text,
        GAP_R020_MD: non_receipt_outputs[GAP_R020_MD],
        BACKLOG_R020_JSON: backlog_text,
        BACKLOG_R020_MD: non_receipt_outputs[BACKLOG_R020_MD],
        FP012_OVERLAY_JSON: non_receipt_outputs[FP012_OVERLAY_JSON],
        FP012_OVERLAY_MD: non_receipt_outputs[FP012_OVERLAY_MD],
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.write_review_subject:
            ...
            print(
                "FP-012 multi-device-session-ledger trace: PASS "
        ...
        print(f"FP-012 multi-device-session-ledger trace: FAIL: {exc}", file=sys.stderr)
        return 1
    mode_name = "WRITE" if args.write else "CHECK"
    print(
        f"FP-012 multi-device-session-ledger trace: PASS outputs={len(outputs)} "
        f"next=FP-047/GAP-056 mode={mode_name}"
    )
    return 0
