#!/usr/bin/env python3
"""Run the signed FP008 seq47a isolated-snapshot corrective reconcile."""
...
ENGINE_PRIVATE_MODULE_PREFIX = "_walksafe_fp008_seq47a_reconcile_engine_"
...
_ENGINE_CONFIGURATION = {
    ...
    "ADDED_AUTHORITY_OPERATION": (
        "walksafe.fp008.seq47a-isolated-snapshot-fix-reconcile.v1"
    ),
    ...
    "REVIEWER_PUBLIC_KEY_SPKI_DER_BASE64": (
        "MCowBQYDK2VwAyEAaYACZtbbZ2ngCBvoFmJBHuy9JBro2SbV8TJPTLlScQk="
    ),
    "REVIEWER_PUBLIC_KEY_SPKI_SHA256": (
        "1705214faabd94b19865d5e1d4115a409e297feff9e2618fafaa0da4fc0586ca"
    ),
    "REVIEWER_PUBLIC_KEY_SPKI_BYTE_COUNT": 44,
    "ED25519_SIGNATURE_BYTE_COUNT": 64,
    "SOURCE_CHECKPOINT_SHA256": (
        "79c7e98843f950f7da9b95fe9661569e3c09d7cce0bd1be72bf6dcf1201e27d5"
    ),
    "SOURCE_CHECKPOINT_BYTE_COUNT": 1_531_096,
    "SOURCE_SEQUENCE": 47,
    "SOURCE_EVENT_SHA256": (
        "82ad77e33eaa55530f53f5ee315807ef66e21fbfc8be2511b004abe99505db90"
    ),
    "SOURCE_CONTENT_SET_SHA256": (
        "e105450086700821021229a97dfc56c634553ce326977f808c69b023cf694452"
    ),
    "MANAGED_PATH_COUNT": 625,
    "PATH_SET_SHA256": (
        "9be08087d975232cd4df6f98fe47a25f1944998e488a52221a9840dd37add59d"
    ),
    "AUTHORIZED_EXISTING_DELTAS": {
        "scripts/run_walksafe_fp008_goal_start_gate_20260803.py": {
            "source_sha256": (
                "a735b5f99d0144dc5cdb07ab9da5f1d317e2221863b4a1d835cecee9accdfc85"
            ),
            "candidate_sha256": (
                "713c4214acd150a1d2a115a978f3771001f78481a2457a0237cc767ac2d77e42"
            ),
        ...
        "tests/test_walksafe_fp008_goal_started_seq47_20260803.py": {
            "source_sha256": (
                "8fa88a9fbc1d4261bd6f7f567e61e6a57133cb0dd1aaf3a4fd48f8407391638a"
            ),
            "candidate_sha256": (
                "76d4668edce157540df19090303651f6ef0eb96546edb6b5d01f48bdc6b24f01"
            ),
        },
        "tests/test_walksafe_fp008_session_snapshot_reconcile_20260808.py": {
            "source_sha256": (
                "d7beb62ea5b6b4d715b26e9657cedc70cb96eb8f68273832b5d6c74f78b6c894"
            ),
            "candidate_sha256": (
                "d3f0e97061406538c57de505c330e58dbd0fe6b30f3734f1ff4a06ebed8243a7"
            ),
        },
        "tests/test_walksafe_project_continuation_v2_4.py": {
            "source_sha256": (
                "659debe13ab754d4fc2015a1227e7292ea67cbda434608889a0cdd8e81a64563"
            ),
            "candidate_sha256": (
...
with zipfile.ZipFile(io.BytesIO(raw), "r") as archive:
    ...
    if (
        len(manifest_raw) != 4767
        or hashlib.sha256(manifest_raw).hexdigest()
        != "e87f30a33b3da07a2bdb8724f2b73c91b11bbc01128e047df8999e29783ecbe1"
    ):
