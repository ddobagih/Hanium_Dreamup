/**
 * Centralizes public runtime defaults and bounded numeric overrides.
 * Fake modes are explicit development modes; no setting here may silently
 * convert a failed real detector into fake safety output.
 */
...
export const DETECTOR_MODE = process.env.NEXT_PUBLIC_DETECTOR_MODE ?? "server-v2";
...
export const WALKSAFE_GUIDANCE_MAX_GPS_ACCURACY_M =
  optionalNumber(process.env.NEXT_PUBLIC_WALKSAFE_GUIDANCE_MAX_GPS_ACCURACY_M, 3, 50) ?? 15;
...
export const WALKSAFE_ARRIVAL_MAX_ACCURACY_M =
  optionalNumber(process.env.NEXT_PUBLIC_WALKSAFE_ARRIVAL_MAX_ACCURACY_M, 3, 50) ?? 20;
...
export const WALKSAFE_SUPERVISED_TACTILE_LOCAL_STEERING_ENABLED =
  process.env.NEXT_PUBLIC_WALKSAFE_SUPERVISED_TACTILE_LOCAL_STEERING === "true";
