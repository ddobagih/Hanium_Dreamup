...
/**
 * Validates and migrates local-only accessibility settings and emergency-contact consent state.
 * Storage access is optional; malformed, unavailable or stale data falls back to safe defaults.
 */
