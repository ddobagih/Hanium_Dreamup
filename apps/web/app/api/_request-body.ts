/** Reads untrusted request bodies with a streaming hard cap before text/JSON parsing. */
...
export async function readBoundedJsonBody(
  ...
  if (!contentType.startsWith("application/json")) return { error: bodyError(415, "json_content_type_required") };
