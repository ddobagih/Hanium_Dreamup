...
/**
 * Draws the ARCore external camera texture. Creation and drawing must stay on the GL thread, and
 * texture coordinates are recomputed from the current frame to honor display geometry changes.
 */
