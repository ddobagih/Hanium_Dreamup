...
- [P0] `GET /navigation/destinations/search` 계약 문서 최신화 / 파일: `docs/walksafe-v2/backend_api_contract.md`, `docs/backend/api_reference.md` / 검증: 코드 route와 문서 endpoint 대조.
...
- [P2] sensor sample local logging schema / 파일: `docs/backend/sensor_log_schema.md` / 검증: schema static.
...
- [P1] fake-v2 저장 허용/차단 정책 명시 / 파일: `docs/operations/report_operations.md`, policy tests / 검증: 정책 맞게 201/422.
...
- [P1] report retention policy 문서 / 파일: `docs/operations/data_retention_policy.md` / 검증: 보존 기간/삭제 승인 gate 명시.
