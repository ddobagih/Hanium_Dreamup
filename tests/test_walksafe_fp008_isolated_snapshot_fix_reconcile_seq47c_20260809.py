...
SCRIPT = (
    ROOT
    / "scripts"
    / "reconcile_walksafe_fp008_isolated_snapshot_fix_seq47c_20260809.py"
)
...
from scripts import reconcile_walksafe_fp008_isolated_snapshot_fix_seq47c_20260809 as reconcile


class WalkSafeFp008IsolatedSnapshotFixSeq47cReconcileTest(unittest.TestCase):
