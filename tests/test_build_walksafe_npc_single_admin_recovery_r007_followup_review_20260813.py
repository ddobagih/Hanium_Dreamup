...
from scripts import build_walksafe_npc_single_admin_recovery_r007_followup_review_20260813 as subject
...
def assignment(context: subject.ReviewContext) -> dict:
    return {
        "schema_version": "1.0",
        "evidence_type": "NPC_R007_FOLLOWUP_REVIEW_ASSIGNMENT",
        "goal_id": subject.trace.GOAL_ID,
        "round_id": subject.ROUND_ID,
        "assigned_at": "2026-08-13T20:40:00+09:00",
        "assigner": identity("codex-r007-assigner", "/root", "INTERNAL_REVIEW_ASSIGNER"),
        "executor": identity("codex-r007-executor", "/root", "INTERNAL_IMPLEMENTATION_EXECUTOR"),
        "reviewer": identity("codex-r007-reviewer", "/root/r007_reviewer", "SEPARATE_INTERNAL_REVIEWER"),
...
def result(context: subject.ReviewContext, assigned: dict, raw: bytes) -> dict:
    return {
        "schema_version": "1.0",
        "evidence_type": "NPC_R007_REVIEWER_AUTHORED_RESULT",
        "goal_id": subject.trace.GOAL_ID,
        "round_id": subject.ROUND_ID,
        "assignment_binding": {
        ...
        "reviewed_at": "2026-08-13T20:41:00+09:00",
        "review_scope": subject._scope(context),
        "decision": "APPROVED",
...
def test_frozen_r003_and_superseded_assignments_are_exact() -> None:
    ...
    assert len(context.superseded_assignment_bindings) == 3
    assert all(
