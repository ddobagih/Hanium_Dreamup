...
from scripts import build_walksafe_npc_single_admin_recovery_r006_followup_review_20260813 as subject
...
def assignment(context: subject.ReviewContext) -> dict:
    return {
        "schema_version": "1.0",
        "evidence_type": "NPC_R006_FOLLOWUP_REVIEW_ASSIGNMENT",
        "goal_id": subject.trace.GOAL_ID,
        "round_id": subject.ROUND_ID,
        "assigned_at": "2026-08-13T20:20:00+09:00",
        "assigner": identity("codex-r006-assigner", "/root", "INTERNAL_REVIEW_ASSIGNER"),
        "executor": identity("codex-r006-executor", "/root", "INTERNAL_IMPLEMENTATION_EXECUTOR"),
        "reviewer": identity("codex-r006-reviewer", "/root/r006_reviewer", "SEPARATE_INTERNAL_REVIEWER"),
...
def result(context: subject.ReviewContext, assigned: dict, raw: bytes) -> dict:
    return {
        "schema_version": "1.0",
        "evidence_type": "NPC_R006_REVIEWER_AUTHORED_RESULT",
        "goal_id": subject.trace.GOAL_ID,
        "round_id": subject.ROUND_ID,
        "assignment_binding": {
        ...
        "reviewed_at": "2026-08-13T20:21:00+09:00",
        "review_scope": subject._scope(context),
        "decision": "APPROVED",
...
def test_frozen_r003_and_superseded_assignments_are_exact() -> None:
    ...
    assert len(context.superseded_assignment_bindings) == 2
    assert all(
